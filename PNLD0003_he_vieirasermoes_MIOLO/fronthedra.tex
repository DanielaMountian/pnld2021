...
\versal{V}658 \hspace{5pt}Vieira, Antônio\\
\hspace{20pt}\parbox{190pt}{Sermões / Padre Antônio Vieira; Iuri Pereira (Organizador) – Rio de Janeiro: Andorinhas, 2021.}\\[6pt]

\hspace{20pt}ISBN 978-65-89777-03-8 (Livro do Estudante)\\
\hspace{20pt}ISBN 978-65-89777-01-4 (Manual do Professor)\\[6pt]

\hspace{20pt}\parbox{190pt}{1. Sermão. 2. Filosofia. 3. Religião. 4. Literatura portuguesa. I. Vieira, Antônio. II. Pereira, Iuri (Organizador). III. Título.}

\hspace{158pt}\versal{CDD} 869.5

\hrulefill

\noindent\textbf{Índice para catálogo sistemático}

\noindent{}I. Sermão : Literatura portuguesa\smallskip
