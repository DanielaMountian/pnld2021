...
\noindent{}O príncipe Vladímir Odóievski (1803--1869) era musicólogo, escritor e
...
\noindent\textbf{Paulo Henrique Pompermaier} é formado em jornalismo pela Faculdade Cásper Líbero e editor"-assistente da Editora Hedra.
...
\tit{DARMAROS}, Marina. \textit{Manual do professor — Contos russos juvenis}. São Paulo: Kalinka, 2021.
...
\tit{KÓBRINSKI}, Aleksándr. \textit{Daniil Kharms. Vida de pessoas notáveis — série de biografias} (\textit{Jizn zametchátelnykh liudéi — seriia biográfii}). Moscou: \textit{Molodaia gvárdiia}, 2009.
...
\tit{MOISÉS}, Massaud. \textit{Dicionário de termos literários: edição revista e ampliada}. São Paulo: Cultrix, 2004;
...
\tit{SEMIÓNOVA}, V. G. (org.). \textit{Os criadores do livro soviético infantil: escritores, poetas, ilustradores (1917–1932)} (\textit{Tvórtsy soviétskoi diétskoi knígui: prozaiki, poéty, khudójniki}). Moscou: Biblioteca Infantil Еstatal da Rússia, 2017.
