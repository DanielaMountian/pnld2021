...
\noindent{}\textls[-28]{Os primeiros contos russos para infância saíram da pena de Catarina \textsc{ii}
(1729--1796), a imperatriz da Rússia de 1762 a 1796: ``Conto do
tsarévitche Cloro'' (\textit{Skazka o tsariévitche Khlore}) e ``Conto do tsarévitche Fevei'', duas parábolas universais.}
...
\textls[-5]{O príncipe Vladímir Odóievski (1803--1869) era musicólogo, escritor e
...
\textls[15]{O príncipe também se interessou pela educação; ele acreditava que as
...
\textls[-25]{A vida de Ivan Turguêniev sofreu uma guinada em 1843, quando ele
...
\textls[-5]{De origem humilde, Nikolai Leskóv (1831--1895), o mais velho de sete
...
\textls[-35]{O posicionamento independente do escritor o fez colecionar polêmicas
...
\textls[-15]{Entre seus trabalhos, muitos com temáticas sociais, destacam"-se os
...
ímpetos e aflições''.\footnote{\textsc{semiónova}, V. G. \emph{Os criadores do
...
\textls[-15]{O nome de Lídia Avílova é geralmente associado ao de Anton Tchékhov, a
...
\textls[-15]{Com uma prosa franca e realista, Aleksándr Kuprin tratou de diversos
...
\textls[-65]{Sacha Tchórny foi expulso de três ginásios por mau aproveitamento, até
...
\textls[-15]{Em 1918, depois de voltar do \emph{front} da Primeira Guerra Mundial,
...
\textls[-5]{1928 foi o ano em que nasceu a \textsc{oberiu}, de que participaram também poetas
...
Catarina \textsc{ii} escreveu ``Conto do tsarévitche Cloro'' em 1781 para seus
...
continuou trabalhando com ela.\footnote{\textsc{darmaros}, Marina. \emph{Manual
...
\textls[-15]{O conto ``O elefante'' (\emph{Slon}) saiu pela primeira vez em 1907,
