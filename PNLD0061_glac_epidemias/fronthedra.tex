...
\linha{posfácio©}{\copyrightilustracao}\smallskip
...
21-58724\hspace{5pt}Medeiros, Claudio\\
\hspace{20pt}\parbox{190pt}{História da experiência das epidemias no Brasil / Claudio Medeiros -- São Paulo: GLAC Edições, 2021.}\\[6pt]

\hspace{20pt}ISBN 978-65-86598-07-0  (Livro do Estudante)\\
\hspace{20pt}ISBN 978-65-86598-08-7  (Manual do Professor)\\[6pt]

\hspace{20pt}\parbox{190pt}{1. Doenças transmissíveis--Brasil. 2. Epidemias--Brasil. 3. Saúde pública--Brasil--História I. Título.}\\[6pt]

\hspace{188pt}\versal{CDD}-614.40981\\

\hrulefill\\
\noindent{}Elaborado por Cibele Maria Dias CRB -- 8/9427 
