...
\begin{quote}
\textit{Epígrafe} \textit{Octavio paz escreveu:} \textit{``A palavra pão,
tocada pela palavra dia,\textit{ }torna-se efetivamente um astro; e o
sol,\textit{ }por sua vez, torna-se alimento\textit{ }luminoso.''}
\textit{Paul de Man escreveu:} \textit{``Ninguém em seu perfeito juízo
ficará à espera\textit{ }de que as uvas em sua videira amadureçam\textit{
}sob a luminosidade\textit{ }da palavra dia''}
\end{quote}

(Ana Martins Marques, \textit{O livro das semelhanças})
