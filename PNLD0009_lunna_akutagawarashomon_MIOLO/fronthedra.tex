...
\hspace{43pt}\tiny\textit{Direitos cedidos à Editora Lunna}\medskip

%\linhalayout{edição brasileira©}{Editora Lunna \ifdef{\ano}{\ano}{\the\year}}
...
\versal{A}XXX \hspace{5pt}Akutagawa, Ryûnosuke (1892--1927)\\
\hspace{20pt}\parbox{185pt}{Rashômon e outros contos / Ryûnosuke Akutagawa. Trad. do japonês de Madalena Hashimoto Cordaro e Junko Ota. -- Rio de Janeiro: Editora Lunna, 2021.}\\[6pt]

\hspace{20pt}204 p.\\[6pt]

\hspace{20pt}ISBN XXX-XX-XXXX-XXX-X\\[6pt]

\hspace{20pt}\parbox{185pt}{1. Literatura japonesa. 2. Conto japonês. I. Título. II. Akutagawa, Ryûnosuke. III. Hashimoto, M. IV. Ota, Junko.}

\hspace{20pt}\versal{CDU} 895-63 \hspace{138pt}\versal{CDD} 895-63
...
\ifdef{\introdutor}{{\small {\introdutor} (\textit{prefácio})} \par}{}\vspace{1.5cm}
...
\vfill
\normalsize
\ifdef{\hfill\includegraphics[width=3cm]{./logo/logo.jpg}\\ São Paulo\quad\the\year}
