...
Ryûnosuke Akutagawa, apesar de sua breve vida ---
suicidou"-se aos 35 anos, em 24 de julho de 1927,
após uma overdose de Veronal ---, legou uma
significativa obra, composta por aproximadamente
150 narrativas curtas.

Considerado o ``pai do conto moderno japonês'', sua obra foi fortemente marcada pela
\textit{Tendências do Novo Pensamento}, ou \textit{Shinshichô}, uma
revista literária e artística cujo primeiro número foi publicado em
1907. À época de sua primeira publicação, a promulgação da Restauração Meiji fazia quarenta anos, com a
...
Significativa é a aparição de Akutagawa entre os participantes da \textit{Shinshichô}, pois indica a tendência moderna de sua e as inovações técnicas e estéticas que incorporava ao seu procedimento artístico. A presente antologia foi organizada para introduzir o leitor brasileiro no universo desse fascinante autor, escolhendo, para isso, os contos mais representativos de sua estética e de sua carreira literária.

Inicia"-se com o conto que dá título ao livro, seu primeiro trabalho de sucesso, e que, juntamente com ``Entre o bosque'', inspiraram o diretor de cinema Akira Kurosawa na produção de seu \textit{Rashômon}. O primeiro conto, já marcado pelo traço moderno do drama psicológico, ambienta"-se no século \textit{xii}, mostrando, ao mesmo tempo, o alinhamento do autor com a tradição japonesa. Já o segundo é uma narrativa nitidamente moderna: sobre um mesmo acontecimento --- o assassinato de um samurai --- vão ser invocadas diversas e conflitantes perspectivas, na tentativa de apreender o que de fato ocorreu.

Além desses dois contos clássicos de Akutagawa, foram selecionadas três narrativas de temática cristã: ``Memorando `Ryôsai Ogata'\,'', ``Ogin'' e ``O mártir''. São importantes pois, além de mostrarem a relação do autor com a religião cristã, evidenciam a forte influência sofrida em partes do Japão pelas missões da Igreja católica, que modificaram a paisagem social da terra do sol nascente.

Os dois contos selecionados em seguida abordam a cultura do período Edo (1603--1868): em ``Terra morta'', o autor joga suas lentes sobre a morte de Bashô Matsuo, um dos principais representantes da tradicional forma poética japonesa do \textit{haikai}. Já em ``Devoção à literatura popular'', coloca"-se em perspectiva o conflito entre a literatura enquanto forma de arte e conhecimento ou como mero entretenimento.

Após o período Edo, o Japão vivencia o período Meiji (1868--1912), época Iluminista, de abertura para o Ocidente e de crença no avanço tecnológico da nação. O período é tematizado no conto ``O baile'', que apresenta a interação de um oficial francês com uma jovem de família japonesa. Os contos que encerram a antologia --- ``Passagens do caderno de notas de Yasukichi'' e ``A vida de um idiota'' --- passam"-se na contemporaneidade do autor, o que também evidencia o caráter altamente biográfico desses textos.

Assim organizada, essa antologia pretende não apenas dar a conhecer ao leitor brasileiro o melhor da produção literária de Akutagawa, como permite uma passagem cronológica pelos diferentes momentos históricos do Japão retratados em sua obra: inicia"-se pelo período Heian, retratado nos primeiros contos, passa pelo momento de cristianização e pelo florescimento cultural do Edo, para desembocar no Japão moderno da Era Meiji e do tempo vivido por seu autor.

\part{\textsc{rashômon e outros contos}}
...
\textls[-5]{Corvos começaram então a se juntar em bandos, vindos sabe"-se lá de
...
\textls[-5]{Escreveu o autor anteriormente: ``Um servo de baixa condição esperava a
...
\textls[-15]{Subiu então, daí a alguns minutos, a meia altura da ampla escada que
...
\textls[-5]{O servo tapou instintivamente o nariz ao perceber o odor pútrido. Mas já
...
\section*{narrativa do morto,\break transmitida por uma médium}
...
\textls[-5]{Livre finalmente das cordas, Ogin se manteve de pé por uns instantes,
...
\hspace{1.2em}Por uma terra morta''.}{Diário de Hanaya\footnotemark}\footnotetext{\textls[-25]{\textit{Diário de Hanaya} é a coletânea de impressões, diálogos
...
em frente de Mokusetsu e ao lado de Shikô,\footnote{\textls[-20]{Shikô Kagami (1665--1731), um dos dez
principais discípulos de Bashô.}}
...
\begin{quote}
\forceindent\ Doente em viagem,\\
\forceindent\ Peregrinam sonhos meus\\
\forceindent\ Por uma terra morta.
\end{quote}
...
\begin{quote}
\forceindent\ Agita"-te, túmulo!\\
\forceindent\ Minha voz que se lamenta\\
\forceindent\ É vento de outono.
\end{quote}
...
\begin{quote}
\forceindent\ Pensar em meus ossos\\
\forceindent\ Expostos no campo ao vento\\
\forceindent\ Que penetra o corpo.
\end{quote}
...
dos \textit{hokku}\footnote{\textls[-5]{\textit{Hokku}: historicamente, nome
...
\hedramarkboth{Passagens do caderno\ldots}{}
