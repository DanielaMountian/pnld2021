...
\hspace{5pt} Athayde, João Martins de\\
\hspace{20pt}\parbox{190pt}{Tipógrafo, poeta e editor / João Martins de
Athayde ; Iuri Pereira (organização). -- 2. ed. -- São Paulo : Editora Hedra, 2021.}\\[6pt]

\hspace{20pt}ISBN 978-65-89705-01-7 (Livro do Estudante)\\
\hspace{20pt}ISBN 978-65-89705-02-4  (Manual do Professor)\\[6pt]

\hspace{20pt}\parbox{190pt}{1. Literatura de cordel 2. Poesia popular
brasileira I. Pereira, Iuri. II. Título.}\\[6pt]

\hspace{20pt}21-60207 \hspace{138pt}\versal{CDD} 398.2\\

\hrulefill\\
\noindent{}Índices para catálogo sistemático:\\
\noindent{}1. Poesia de cordel : Folclore 398.2\\[6pt]
