...
C267 \hspace{5pt}Cardim, Fernão \\
\hspace{20pt}\parbox{190pt}{Tratado da terra e gente do Brasil / Fernão Cardim; Ana Maria de Azevedo (Organizadora) – Rio de Janeiro: Prosper, 2021.}\\[6pt]

\hspace{20pt}ISBN 978-65-994233-3-8 (Livro do Estudante)\\
\hspace{20pt}ISBN 978-65-994233-1-4  (Livro do Professor)\\[6pt]

\hspace{20pt}\parbox{190pt}{1. História do Brasil. 2. Brasil Colônia. 3. História. I. Cardim, Fernão. II. Azevedo, Ana Maria de (Organizadora). III. Título.}\\[6pt]

\hspace{188pt}\versal{CDD} 981.03\\
