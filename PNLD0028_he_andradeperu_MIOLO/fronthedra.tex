...
A553 \hspace{5pt}Andrade, Mário de\\
\hspace{20pt}\parbox{190pt}{O peru de Natal e outros contos / Mário de Andrade; Rodrigo Jorge Ribeiro Neves (Organizador) – Rio de Janeiro: Youkali, 2021.}\\[6pt]

\hspace{20pt}ISBN 978-65-994222-0-1 (Livro do Estudante)\\
\hspace{20pt}ISBN 978-65-994222-3-2  (Manual do Professor)\\[6pt]

\hspace{20pt}\parbox{190pt}{1. Conto. 2. Modernismo. 3. Clássico da literatura brasileira. 4. Literatura brasileira. I. Andrade, Mário de. II. Neves, Rodrigo Jorge Ribeiro (Organizador). III. Título.}\\[6pt]

\hspace{188pt}\versal{CDD} 869.3\\

\hrulefill\\
\noindent{}Índice para catálogo sistemático\\
\noindent{}I. Conto : Literatura brasileira\\[6pt]
