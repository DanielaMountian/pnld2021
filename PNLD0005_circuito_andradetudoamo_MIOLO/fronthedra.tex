...
N518 \hspace{5pt}Souza, Cristiane Rodrigues de, Org.\\
\hspace{20pt}\parbox{190pt}{Eu tudoamo: uma antologia poética. Mário de Andrade / Organização de Cristiane Rodrigues de Souza. – Rio de Janeiro: Circuito, 2021.}\\[6pt]

\hspace{20pt}ISBN 978-65-86974-19-5 (Livro do Estudante)\\
\hspace{20pt}ISBN 978-65-86974-23-2 (Manual do Professor)\\[6pt]

\hspace{20pt}\parbox{190pt}{1. Literatura Brasileira. 2. Poesia. 3. Antologia Poética. 4. Andrade, Mário de (1893--1945). I. Título. II. Uma antologia poética. III. Mário de Andrade. IV. Souza, Cristiane Rodrigues de, Organizador. V. Andrade, Mário Raul Morais de (1893--1945). VI. PNLD Obras Literárias -- Livro do Aluno. VII. PNLD Obras Literárias -- Manual do Professor}\\[6pt]

\hspace{20pt}CDU 821.134.1(81) \hspace{138pt}\versal{CDD}-B869.1

\hrulefill

\noindent{}Regina Simão Paulino -- Bibliotecária -- CRB-6/1154
...
\vfill
\normalsize
\ifdef{\hfill\includegraphics[width=3cm]{\logoeditora}\\ Rio de Janeiro\quad\the\year}
