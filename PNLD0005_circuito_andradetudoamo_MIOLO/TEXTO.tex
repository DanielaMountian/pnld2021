...
passa galhardo um filho de imigrante,\\ \enlargethispage{\baselineskip}
...
\hfill{}{\small(num estampido preto)}
...
\hfill{}{\small(A orquestra num crescendo cromático}

\hfill{}{\small de contrabaixos anuncia\ldots{})}
...
\hfill{}{\small(a orquestra súbito emudece, depois}

\hfill{}{\small duma grande gargalhada de timbales)}
...
\hfill{}{\small(\emph{Tutti.} O crescendo é resolvido}

\hfill{}{\small{numa solene marcha fúnebre)}
...
\hfill{}{\small(loucos, sublimes, tombando exaustos)}

\begin{verse}
Seus\dotfill{}!\mbox{}!\mbox{}!\\
...
Esposo.\\
Do esposo recebido ante a imponência catedrática da Lei\\ \enlargethispage{\baselineskip}
...
\paginabranca
\partepigraph{\emph{Quid, homo, ineptam sequeris laetitiam}.}{\textsc{séc.\,xi}}
...
\chapterspecial{Tempo da maria}{(1926)}{}
...
E a paixão será arquivada.\\ \enlargethispage{\baselineskip}
...
Pra não ver quem te quer bem!\\ \enlargethispage{\baselineskip}
Olhos de jabuticaba!\\
...
E hoje as donas são assim\ldots{} \enlargethispage{\baselineskip}
...
\chapterspecial{Poemas da amiga}{(1929--1930)}{}
...
Que até meu olhar fechou. \enlargethispage{\baselineskip}
...
Ameaçados pela fome que espia detrás da coxilha,\\ \enlargethispage{\baselineskip}
...
São deuses\ldots{}\\ \enlargethispage{\baselineskip}
...
Nos Pireneus em pororoca prodigiosa\\ \enlargethispage{\baselineskip}
...
\quad Vou seguindo no cortejo\\ \enlargethispage{\baselineskip}
E vira o coco Sinhá!
\end{verse}
...
\part*{\textsc{café}\\{\large\textsc{tragédia coral em três atos}\\\textsc{o poema}\\
...
\chapterspecial{Losangos arlequinais}{(Sonetos condensados)\footnote[*]{Publicado em \textsc{O mês modernista}, em 2 de janeiro de 1926, seção do jornal carioca \emph{A
  ...
  (\textsc{andrade}, Mário de, op. cit., p. 155).}}{}
...
\chapterspecial{Seção livre}{Comunicação urgente\footnote[*]{Publicado em \emph{Terra roxa e
  ...
  Figueiredo (\textsc{andrade}, Mário de, op. cit., p. 164).}}{}
...
\footnotetext{O poema aparece como parte do artigo \textsc{lorca},
  ...
  Longo Figueiredo (\textsc{andrade}, Mário de, op. cit., p. 177).}
...
\chapterspecial{Noturno n° 4}{(janeiro de 1924)\footnote[*]{``Poema enviado a Anita Malfatti na carta de 3 de janeiro de 1924, autógrafo a tinta preta em folha de papel
  ...
  n° 3}'', de acordo com as organizadoras das
  \emph{Poesias completas} (\textsc{andrade}, Mário de, op. cit., p. 193).}}{}
...
\chapter[Reza de fim de ano (5º Noturno)\medskip]{Reza de fim de ano (5º Noturno) \subtitulo{(31 de dezembro de 1923 -- 1º de janeiro de 1924)}\footnote{``O poema, logo ao final da
...
\qquad\quad 23 no relógio do Correio.\\
...
\movetooddpage
\addcontentsline{toc}{chapter}{\normalsize\textsc{inéditos e de publicação póstuma}}
...
Minha viola gemeu\\
Meu coração estremeceu,\\
Minha viola quebrou\\ \enlargethispage{\baselineskip}
Teu coração me deixou!
\end{verse}
...
\chapterspecial{Cântico}{(São Paulo, 6 de maio de 1933)\footnote[*]{Em nota, Telê Ancona Lopez e Tatiana Longo
  ...
  \textsc{ieb"-usp})'' (\textsc{andrade}, Mário de, op. cit., p. 266).}}{}
...
\chapterspecial{Nova canção de Dixie}{(São Paulo, 25 de janeiro de 1944)\footnote[*]{Telê Ancona Lopez e Tatiana Longo
  ...
  fevereiro de 1946)'' (\textsc{andrade}, Mário de, op. cit., p. 277).}}{}
...
\chapterspecial{Esboço \textsc{vi}}{(São Paulo, 21 de junho de 1944)\footnote[*]{Como lembram Telê Ancona Lopez e Tatiana
  ...
  manuscrito de \emph{Lira paulistana} (Arquivo Mário de Andrade,
  \textsc{ieb"-usp})'' (\textsc{andrade}, Mário de, op. cit., p. 281).}}{}
