...
\hspace{43pt}\tiny\textit{Direitos cedidos à Editora EdLab}\medskip
...
% Resumo -------------------------------------------------------
\begingroup \footnotesize \parindent0pt \parskip 5pt \thispagestyle{empty} \vspace*{-.5\textheight}\mbox{} \vfill
