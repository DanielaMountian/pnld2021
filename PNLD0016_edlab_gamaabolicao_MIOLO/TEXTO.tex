...
\chapter{Emancipação \textsc{ii}\footnote[*]{In: \emph{A Província de S.\,Paulo} (\textsc{sp}), Seção Livre, 04/12/1880, p.\,1.}} %{]} À redação da ``Província''
...
\chapter{Emancipação \textsc{iv}\footnote[*]{In: \emph{Gazeta do Povo} (\textsc{sp}), Publicações Pedidas, 18/12/1880, p.\,2.}} %A  em..--- ao pé da letra {[}{]}
