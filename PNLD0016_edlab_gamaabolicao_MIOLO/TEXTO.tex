...
Aos escravos nomeados prometi e \textsc{dou} o seguinte:
...
Oliveira. O que Gama continuaria a narrar seria uma espécie de flagrante forjado, com direito a invenção
...
de bastante prestígio, dois dos irmãos Andradas, e assinada, na
...
\emph{Dr.\,Antonio Carlos R. de A. Machado e Silva}\footnote{Antonio
  ...
  Santos (\textsc{sp}) e pertence à segunda geração dos Andradas, sendo sobrinho
...
\textsc{alencar araripe}.\footnote{Tristão de Alencar Araripe (1821--1908),
...
\textsc{aquino e castro}.\footnote{Olegário Herculano de Aquino e Castro
...
\textsc{j. n. dos santos}\footnote{José Norberto do Santos (?--?) foi político e
...
\textsc{a. l. da gama}.\footnote{Agostinho Luiz da Gama (?--1880), nascido na
...
\textsc{antonio d.\,da. c. bueno} --- (juiz)

\textsc{f. h. trigo de loureiro} --- (perito)

\textsc{joão r. da. f. rosa} --- (idem)

\textsc{h. a. b. vincent} --- (promotor)

\textsc{j. moreira lyrio} --- (testemunha)

\textsc{m. c. quirino chaves} --- (idem)

\textsc{e. de oliveira machado} --- (escrivão)
...
\section*{DAS CAUSAS EM FAVOR DA LIBERDADE}
...
\textsc{manoel josé de souza frança}''\footnote{A transcrição da portaria
...
pensamento ``libérrimo''\footnote{Superlativo de livre, algo como
  muitíssimo livre, muitíssimo liberal.}, sustentado pelo exmo.\,sr.\,conselheiro Nabuco de Araújo em um parecer, e por eméritos deputados e
...
\part{O ás da abolição: cartas de Gama a F.\,Menezes}
...
introdutores\ldots{} os filantropos não terão que dizer, vendo que, para as
...
\textsc{campos mello}\footnote{Antonio Manuel de Campos Mello (1809--1878) foi
...
\textsc{josé vergueiro}\footnote{Veja nesse volume a carta que Gama endereçou a
