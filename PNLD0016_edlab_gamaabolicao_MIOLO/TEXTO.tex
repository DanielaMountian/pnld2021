...
histórico.\footnote{Friderich Carl von Savigny (1779-1861), nascido em
  ...
  do século XIX do qual Savigny foi um dos principais doutrinadores.}
...
\chapter{Foro de Jundiaí -- (Delegacia de Polícia)\footnote[*]{In: \emph{Correio Paulistano} (SP), A Pedido,
...
Sabe todo o país que o sr. Victor Telles\footnote{Victor Telles de
  ...
  Uruguai, e em Pelotas (RS), e morava em São Paulo, onde tinha um estúdio de
...
de 1878; opinião do respeitável sr. dr. Teixeira de Freitas\footnote{
  ...
  de Código Civil que, todavia, não chegou a ser concluído no século XIX.}
...
deste?\footnote[*]{In: \emph{Gazeta de S. Paulo} (SP), Ineditoriais,
  ...
  compreendê-lo como \emph{Questão Jurídica -- parte II}. Não por
...
lenitivo do açoite!... \footnote{Ainda uma palavra sobre o uso
...
1831... uma jovem formosíssima enfermou.
...
Pedro II estaria em perigo. Vejamos a "rude linguagem". Nas palavras de Gama e seus
...
Rocio.\footnote{Refere-se à atual praça Tiradentes, no centro do Rio
  de Janeiro (RJ), que antigamente se chamava Largo Rocio, em
