...
\hspace{5pt}Twain, Mark, 1835--1910\\
\hspace{20pt}\parbox{190pt}{Diários de Adão e Eva / Mark Twain ; Hanna B.
Gotz e Sergio Romanelli (tradução). -- 1. ed. -- São Paulo : EdLab Press, 2021.}\\[6pt]

\hspace{20pt}ISBN 978-65-89829-03-4 (Livro do Estudante)\\
\hspace{20pt}ISBN 978-65-89829-02-7  (Manual do Professor)\\[6pt]

\hspace{20pt}\parbox{190pt}{1. Ficção norte-americana I. Título.}\\[6pt]

\hspace{20pt}21-60591 \hspace{138pt}\versal{CDD} 813\\

\hrulefill\\
\noindent{}Índices para catálogo sistemático:\\
\noindent{}1. Ficção : Literatura norte-americana\\[6pt]
