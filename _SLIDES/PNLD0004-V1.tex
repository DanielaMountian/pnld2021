...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0004-01.png}{\includegraphics[width=5cm]{PNLD0004-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Madalena; Ficção, mistério e fantasia; Conto, crônica e novela; Mário de Andrade; Zeppelin: algumas crônicas de Mário de Andrade
