...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0013-01.png}{\includegraphics[width=5cm]{PNLD0013-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Ayllon; Ficção, mistério e fantasia; Romance; Daniel Defoe; Robinson Crusoé
