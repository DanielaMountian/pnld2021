...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0045-01.png}{\includegraphics[width=5cm]{PNLD0045-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Hedra; Ficção, mistério e fantasia; Poema; José Martins de Athayde; Tipógrafo, poeta e editor
