...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0046-01.png}{\includegraphics[width=5cm]{PNLD0046-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Araucária; Ficção, mistério e fantasia; Romance; Xavier de Maistre; Viagem em volta do meu quarto
