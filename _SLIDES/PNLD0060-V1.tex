...
\hfill\IfFileExists{PNLD0060-01.png}{\includegraphics[width=6cm]{PNLD0060-01.png}}{Sem capa!}
\end{figure}
\end{frame}
...
\end{document}
% Ubu; História da ciência; Tratado científico; Charles Darwin; Origem das espécies
