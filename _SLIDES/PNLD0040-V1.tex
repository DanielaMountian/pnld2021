...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0040-01.png}{\includegraphics[width=5cm]{PNLD0040-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Blooks; Ficção, mistério e fantasia; Conto, crônica e novela; Strindberg; Sagas
