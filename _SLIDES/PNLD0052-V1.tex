...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0052-01.png}{\includegraphics[width=5cm]{PNLD00052-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
Alameda; Diálogos com a sociologia e com a antropologia; Diário, biografia, autobiografia, relato% s, memórias; Irineu Franco Perpétuo; História concisa da música clássica brasileira
