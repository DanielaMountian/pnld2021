...
\hfill\IfFileExists{PNLD0056-01.png}{\includegraphics[width=6cm]{PNLD0056-01.png}}{Sem capa!}
\end{figure}
\end{frame}
...
\end{document}
Livros de Criação; Diálogos com a sociologia e com a antropologia; Diário, biografia, autobi% ografia, relatos, memórias; Sojourner Truth; A narrativa de Sojourner Truth
