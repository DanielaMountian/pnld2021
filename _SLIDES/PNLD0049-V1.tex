...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0049-01.png}{\includegraphics[width=5cm]{PNLD0049-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Kalinka; Ficção, mistério e fantasia; Romance; Aleksei Tolstoi; Infância de Nikita
