...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0009-01.png}{\includegraphics[width=5cm]{PNLD0009-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Editora Lunna; Ficção, mistério e fantasia; Conto, crônica e novela; Akutagawa; Rashômon
