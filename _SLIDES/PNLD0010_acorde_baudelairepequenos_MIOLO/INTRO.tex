\addcontentsline{toc}{chapter}{Charles Baudelaire, o homem das multidões, \emph{por Dirceu Villa}}
\chapter*{Charles Baudelaire, o homem das multidões}
...
\textls[-4]{\textit{Le Spleen de Paris} praticamente inaugura um gênero,\footnote{
...
\textls[-4]{Mallarmé escreverá alguns poemas em prosa também, claramente baseados no
