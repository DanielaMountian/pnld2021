...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0036-01.png}{\includegraphics[width=5cm]{PNLD0036-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Escola de Pais; Ficção, mistério e fantasia; Conto, crônica e novela; Marcel Schwob; Vidas imaginárias e outros textos
