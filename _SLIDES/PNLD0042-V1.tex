...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0042-01.png}{\includegraphics[width=5cm]{PNLD0042-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Madalena; Ficção, mistério e fantasia; Romance; Liev Tolstói; A morte de Ivan Ílitch
