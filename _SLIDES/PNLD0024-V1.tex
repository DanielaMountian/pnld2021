...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0024-01.png}{\includegraphics[width=5cm]{PNLD0024-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Circuito; Ficção, mistério e fantasia; Conto, crônica e novela; Monteiro Lobato; Um suplício moderno e outros contos
