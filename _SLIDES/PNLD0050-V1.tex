...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0050-01.png}{\includegraphics[width=5cm]{PNLD0050-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Kalinka; Ficção, mistério e fantasia; Conto, crônica e novela; Daniela Mountian (Org.); Contos russos infanto juvenis
