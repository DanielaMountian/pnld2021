...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0030-01.png}{\includegraphics[width=5cm]{PNLD0030-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Nexus; Ficção, mistério e fantasia; Poema; Orides Fontela; Poemas escolhidos
