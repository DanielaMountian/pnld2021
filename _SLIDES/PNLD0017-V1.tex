...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0017-01.png}{\includegraphics[width=5cm]{PNLD0017-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Hedra Educação; Ficção, mistério e fantasia; Romance; Robert Louis Stevenson; O médico e o monstro
