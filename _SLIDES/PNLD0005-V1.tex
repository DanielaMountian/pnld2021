...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0005-01.png}{\includegraphics[width=5cm]{PNLD0005-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Circuito; Ficção, mistério e fantasia; Poema; Mário de Andrade; Eu tudoamo: antologia de poemas de Mário de Andrade
