...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0014-01.png}{\includegraphics[width=5cm]{PNLD0014-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Acorde; Ficção, mistério e fantasia; Conto; crônica, novela e poema; Maria Firmina dos Reis; Antologia de prosa e versos
