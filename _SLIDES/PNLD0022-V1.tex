...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0022-01.png}{\includegraphics[width=5cm]{PNLD0022-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Hedra Educação; Ficção, mistério e fantasia; Romance; James Joyce; Stephen Heroi
