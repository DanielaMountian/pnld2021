...
\hfill\IfFileExists{PNLD0055-01.png}{\includegraphics[width=6cm]{PNLD0055-01.png}}{Sem capa!}
\end{figure}
\end{frame}
...
\end{document}
% Livros de Criação; Ficção, mistério e fantasia; Conto, crônica e novela; Nella Larsen; Passando-se
