...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0018-01.png}{\includegraphics[width=5cm]{PNLD0018-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Iluminuras; Ficção, mistério e fantasia; Romance; Heinrich Heine; O Rabi de Bacherach
