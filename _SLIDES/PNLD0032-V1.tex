...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0032-01.png}{\includegraphics[width=5cm]{PNLD0032-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Hedra Educação; Ficção, mistério e fantasia; Conto, crônica e novela; James Joyce; Dublinenses
