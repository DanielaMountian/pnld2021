...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0041-01.png}{\includegraphics[width=5cm]{PNLD0041-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Mais e Melhores; Ficção, mistério e fantasia; Conto, crônica e novela; Johann Ludwig Tieck; Feitiço de amor e outros contos
