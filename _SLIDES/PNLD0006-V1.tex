...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0006-01.png}{\includegraphics[width=5cm]{PNLD0006-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Ayllon; Ficção, mistério e fantasia; Conto, crônica e novela; Marcus Baccega (Org.); A demanda do Santo Graal
