\chapter{Prefácio\footnote{A
  ...
  Paulo, com apoio da \textsc{fapesp}.}} \label{part0}
...
\textsc{xxi}.\footnote{\textsc{hellman}, Ben. \emph{Contos maravilhosos e histórias reais:
  ...
  russkoi diétskoi literatury}). Moscou: \emph{Nóvoie
...
que da própria Catarina \textsc{ii} (1729--1796), imperatriz da Rússia de 1762 a
...
Tolstói; e ``A cidadezinha da tabaqueira'' (1834), parte
...
metade do século \textsc{xix} e início do \textsc{xx}, surge no império russo a
...
texto é cinematográfico. Muito estimado por Tolstói e baseado em
...
(1832), conto de Nikolai Gógol (1809--1852), que narra a história
...
russos''.\footnote{\textsc{turguêniev}, Ivan. Prefácio. \emph{Diário de menina}
...
``Primeira mágoa'', em que o menino Gricha, com a prisão do
...
Avílova e o tinha como mestre. Numa carta de 1901,\footnote{\textsc{kuprin},
...
selecionado o ``Conto da filha de fabricante de caixões'' (1915),
