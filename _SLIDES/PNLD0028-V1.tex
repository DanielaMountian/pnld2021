...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0028-01.png}{\includegraphics[width=5cm]{PNLD0028-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Hedra Educação; Ficção, mistério e fantasia; Conto, crônica e novela; Mário de Andrade; O peru de natal e outros contos
