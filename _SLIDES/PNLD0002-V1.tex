...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0002-01.png}{\includegraphics[width=5cm]{PNLD0002-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}


% \hfill\IfFileExists{capa.png}{
% 		\begin{figure}
% 			\includegraphics[width=5cm]{capa.png}
% 		\end{figure}}{Sem capa!}
% \end{figure}
%  & 
% \textsc{vídeotutorial do aluno}
% Slides -------------------------------------------------------------------
