...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0043-01.png}{\includegraphics[width=5cm]{PNLD0043-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% EdLab Press; Ficção, mistério e fantasia; Conto, crônica e novela; Mark Twain; Diários de Adão e Eva
