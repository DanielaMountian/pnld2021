...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0053-01.png}{\includegraphics[width=5cm]{PNLD0053-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Alameda; Ficção, mistério e fantasia; Romance; Bernardo Kucinski; Júlia – Nos campos confla% grados do Senhor
