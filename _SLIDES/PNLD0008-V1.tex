...
\vspace{-2cm}\begin{figure}
	\IfFileExists{PNLD0008-01.png}{\includegraphics[width=5cm]{PNLD0008-01.png}}{Aplicar Capa!!}
\end{figure}
\end{frame}
...
\end{document}
% Araucária; Ficção, mistério e fantasia; Romance; Fábio Atui; Mare nostrum: Paranã Tipi
