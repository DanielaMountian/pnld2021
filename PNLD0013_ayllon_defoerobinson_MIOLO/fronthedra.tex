...
\hspace{5pt}Defoe, Daniel, 1660-1731 \\
\hspace{20pt}\parbox{190pt}{Robinson Crusoé / Daniel Defoe ; tradução Bruno
Gambarotto. -- 1. ed. -- São Paulo : Ayllon, 2021.}\\[6pt]

\hspace{20pt}ISBN 978-65-994304-2-8 (Livro do Estudante)\\
\hspace{20pt}ISBN 978-65-994304-3-5  (Manual do Professor)\\[6pt]

\hspace{20pt}\parbox{190pt}{1. Literatura infantojuvenil I. Título.}\\[6pt]

\hspace{20pt}21-60307 \hspace{138pt}\versal{CDD}-028.5\\

\hrulefill

\noindent{}\textbf{Índices para catálogo sistemático:}\\
\noindent{}1. Literatura infantojuvenil 028.5 \\
\noindent{}2. Literatura juvenil 028.5\\[6pt]
\noindent{}Aline Graziele Benitez -- Bibliotecária -- CRB-1/3129
