...
A aventura de Crusoé, no entanto, se inicia com os sentidos morais das
...
%Walcott (1930--2017), escreveu poemas lidando com o personagem Crusoé.
...
%2007 um artigo chamado ``A figura de Crusoé na poesia de Derek
%Walcott'', no qual percebe e registra um jogo de engenho notável em seu
%poema ``Crusoé's Journal'', um ajuste de contas poético: mesclado das
...
%linguagem absorvida. Crusoé, que impusera um nome ao nativo e
...
\emph{Robinson Crusoé} é, portanto, um livro direto, lido até mesmo em
