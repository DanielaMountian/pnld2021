...
\textls[-35]{Meados de outubro, novembro, dezembro, janeiro, meados de fevereiro}
 \switchcolumn
...
\textls[-5]{Descobri que ele era muito hábil na condução da canoa, capaz de
...
\textls[-5]{Havia outra árvore, e arbustos cerrados logo adiante dela, obra de
...
\textls[-10]{Conservei minha arma na mão, sem atirar, mas com o intuito de manter"-me
...
\begin{enumerate}[label=\arabic*]
\setcounter{enumi}{3}
\item \textls[-5]{morreram, aqui e ali, em decorrência dos ferimentos, ou foram mortos
...
\textls[-5]{``Mas'', disse o velho, ``tenho uma notícia para lhe dar, que talvez não
...
\textls[-5]{Dessa forma, parti de Lisboa; e estando nossa companhia muito bem
...
\textls[-10]{Mas Sexta"-Feira rapidamente dirimiu nossas dúvidas; pois vendo que o
...
\textls[-20]{Para tanto, escrevi ao meu velho amigo de Lisboa, que, em resposta,
...
\textls[-25]{Assim, concordei, dando"-lhe ordem de oferecê"-la a eles, e ele assim o
