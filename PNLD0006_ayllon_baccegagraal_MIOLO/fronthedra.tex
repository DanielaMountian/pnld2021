...
\hspace{5pt}A demanda do Santo Graal : o manuscrito de\\
\hspace{20pt}\parbox{190pt}{Heidelberg / tradução e organização Marcus Baccega. -- 1. ed.
-- São Paulo : Ayllon, 2021.}\\[6pt]

\hspace{20pt}ISBN 978-65-994304-1-1  (Livro do Estudante)\\
\hspace{20pt}ISBN 978-65-994304-0-4  (Manual do Professor)\\[6pt]

\hspace{20pt}\parbox{190pt}{1. A demanda do Santo Graal.}\\[6pt]

\hspace{20pt}21-60304 \hspace{138pt}\versal{CDD}-398.22\\

\hrulefill\\
\noindent{}Índices para catálogo sistemático:\\
\noindent{}1. Santo Graal : Literatura folclórica : História e crítica 398.22\\[6pt]
