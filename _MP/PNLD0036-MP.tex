...
\newcommand{\issnppub}{978-65-994439-0-9}
\newcommand{\issnepub}{978-65-994439-3-0}
...
Marcel Schwob (1867--1905) foi um ficcionista, ensaísta e tradutor nascido em Chaville, região de Champagne, na França, e morto em Paris. 
Ocupou, ao final do século \textsc{xix}, um lugar de referência nos círculos literários parisienses, 
...
Entre suas obras mais importantes estão \textit{O livro de Monelle}, \textit{A cruzada das crianças} e 
\textit{Vidas imaginárias}, presentes no livro que 
temos em mãos. Apresentaremos brevemente cada uma delas abaixo.

\textit{A cruzada das crianças}, de 1896, tem como ponto de partida as crônicas 
...
sobre o acontecimento. Publicada no mesmo ano, \textit{Vidas imaginárias}, reúne 
...
Já \textit{O livro de Monelle}, de 1894, é uma das obras mais conhecidas de 
...
\Image{\textit{A cruzada das crianças}, na ilustração de Gustave Dorée, representa a mítica cruzada que inspirou Schwob na escrita do presente livro. (Domínio público)}{PNLD0036-12}
...
\BNCC{EM13LP53}
 ...
 \paragraph{Metodologia}
 	\begin{enumerate}
\SideImage{Trovadores da Idade Média, aedos da Grécia antiga, griôs
da África e repentistas do Nordeste brasileiro têm comum a arte de contar histórias acompanhados de música. (Autor desconhecido. Domínio público.)}{PNLD0036-13}
 		\item
 		...
 		galaico"-portuguesa.
 		\item\href{https://www.youtube.com/watch?v=wLeI9KlGPq4}{\emph{O cabrito e o lobo}}, Contadores de História, na \textsc{tv} Cultura.
...
\SideImage{Retrato do autor desenhado por Theodore Simson em 1905, ano de seu falecimento. (Theodore Frederick Spicer Simson; Domínio Público)}{PNLD0036-04.png}
...
% \SideImage{Publicação de 1927 de Marcel Schwob, com seus escritos da juventude. (Gallica; Domínio Público)}{PNLD0036-10.png}
...
% constituem esse volume: \textit{A Cruzada das Crianças}, que transforma um fato
% histórico em fato literário, e \textit{Vidas Imaginárias}, que desnuda o traço
...
\Image{Mapa da rota das Cruzadas, expedições militares organizadas com a benção da Igreja Católica. (Rowanwindwhistler; \textsc{cc}-\textsc{by}-\textsc{sa}-3.0)}{PNLD0036-05.png}
...
\Image{Manuscrito medieval de 1474 que buscou representar a Cruzada Popular de Pedro, o Eremita, de 1096, o movimento extraoficial da Primeira Cruzada (Biblioteca Nacional da França; Domínio Público)}{PNLD0036-06.png}
...
\SideImage{Representação do Papa Inocêncio \textsc{iii} feita entre 1275 e 1230. (\emph{Grandes Chroniques de France}, Bibliothèque Sainte"-Geneviève; \textsc{cc}-\textsc{by}-\textsc{sa}-3.0)}{PNLD0036-08.png}
...
\Image{O quadro de Manuel de La Cruz, de 1788, representa uma visão do Papa Inocêncio \textsc{iii}, relacionada com São Francisco de Assis. (Manuel de la Cruz; Domínio Público)}{PNLD0036-09.png}
