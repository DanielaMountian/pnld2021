...
\Image{``A cruzada das crianças'', na ilustração de Gustave Dorée, representa a mítica cruzada que inspirou Schwob na escrita do presente livro. (Domínio público.)}{PNLD0036-12}
...
\BNCC{EM13LP53}
 ...
 \paragraph{Metodologia}
 	\begin{enumerate}
 		...
 		- \href{https://www.youtube.com/watch?v=wLeI9KlGPq4}{``O cabrito e o lobo''. Contadores de História (TV Cultura)}
...
\SideImage{Os trovadores, na Idade Média europeia, bem como os aedos na Grécia antiga, os griôs
...
Papas (Inocêncio \texsc{iii} e Gregório \textsc{ix}), um leproso, um muçulmano, um
...
publicada no jornal \textit{O farol do Loire} (\textit{Le phare de la Loire}), pertencente
...
Ciências Sociais (\textit{École des Hautes Etudes Sociales}) e na Sorbonne, tendo
...
coletâneas de contos: \textit{Cœur double} (\textit{Coração duplo}, 1891), \textit{Le Roi au
masque d'or} (\textit{O rei na máscara de ouro}, 1892), \textit{Mimes} (1893), \textit{Le livre de
Monelle} (\textit{O livro de Monelle}, 1894), \textit{La croisade des enfants} (\textit{A cruzada
das crianças}, 1896) e \textit{Vies imaginaires} (\textit{Vidas imaginárias}, 1896).
...
Ubu Roi) e Oscar Wilde (que lhe dedica seu longo poema \textit{The Sphinx}, em
...
Igreja Católica, durante parte da Idade Média (do final do século \texsc{xi} à
...
1099, sob o papado de Urbano \textsc{ii}. Dentre todas elas, a chamada \textit{Cruzada
...
\begin{itemize}
\item
  O manuscrito de Lüneburg (séc. \textsc{xv}) faz referência a um acontecimento
  envolvendo 130 crianças desaparecidas em 26 de junho de 1284, seguindo
  um flautista até Koppen.
\end{itemize}

\subsection{O relato de Inocêncio \textsc{iii}}
...
\SideImage{Representação do Papa Inocêncio \textsc{iii} feita entre 1275 e 1230. (Grandes Chroniques de France,  Bibliothèque Sainte"-Geneviève; CC-BY-SA-3.0)}{PNLD0036-08.png}
...
ficcional ou bio"-ficção. Segundo o autor, há uma diferença entre relatar
...
fins do século textsc{xvi}), William Phips (caça"-tesouros inglês), Capitão Kid
