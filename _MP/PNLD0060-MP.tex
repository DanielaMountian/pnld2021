...
outros, o seguite questionamento: a extinção de seres vivos devida aos ``avanços'' 
...
\begin{enumerate}
	...
	A partir daí, deve organizar uma visita, presencial ou virtual, a algum musei em que os alunos possam
	...
	em argila de uma das espécies em extinção, ou mesmo em vias de.
...
% inserir imagem PNLD0060-11.png {Tirinha cômica sobre a teoria darwiniana da seleção natural. Disponível em:
