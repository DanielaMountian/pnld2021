...
%\Image{Desenho botânico da flor prímula (Alex Cerveny; Rights Managed)}{PNLD0060-08.png}


%\Image{Desenho de uma mariposa (Alex Cerveny; Rights Managed)}{PNLD0060-09.png}


%\Image{Desenho de um pássaro quiuí (Alex Cerveny; Rights Managed)}{PNLD0060-10.png}
...
%\Image{Ilustração da viagem marítima. (Alex Cerveny; Rights Managed)}{PNLD0060-05.png}
...
%\Image{Estrutura do navio Beagle (Alex Cerveny; Rights Managed)}{PNLD0060-04.png}
...
%\Image{Diagrama de ramificação dos roedores e marsupiais a partir de uma mesma matriz. Década de 1850. (Charles Darwin; Domínio Público)}{PNLD0060-07.png}
...
%\Image{Esquema geral de ramificação das espécies por seleção natural. Década de 1840. (Charles Darwin; Domínio Público)}{PNLD0060-06.png}
