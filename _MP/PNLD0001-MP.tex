...
% \imagem{Foto presente na ficha da primeira internação manicomial de Lima Barreto — 1914. (Acervo da Biblioteca do Instituto de Psiquiatria da UFRJ, 1914.; Domínio público)}{PNLD0001-03.png}
% \imagem{Enchente na Rua Benedito Hipólito, Rio de Janeiro. Fotografia de 1951. A preocupação com a gestão pública nas cidades é tema da crônica As Enchentes. (Autor desconhecido (https://commons.wikimedia.org/wiki/File:Lossless-page1-800px-Enchente_na_Rua_Benedito_Hip%C3%B3lito,_Rio_de_Janeiro_(RJ).tif.png); CC BY-SA 4.0)}{PNLD0001-04.png}
% \imagem{Lélia Gonzalez foi uma antropóloga e filósofa com estudos sobre a linguagem coloquial e o racismo na sociedade brasileira. (Cezar Loureiro, Revista Cult; Domínio público)}{PNLD0001-05.png}
% \imagem{A quermesse retratada na foto traz paralelos com o "mafuá" e a feira de prendas relatado pelo autor. (Escola Estadual Antonio Vicente Azambuja; CC-BY-SA-4.0)}{PNLD0001-06.png}
% \imagem{Foi em A Noite que Lima Barreto publicou, de março a julho de 1915, em folhetos, o romance satírico Numa e a Ninfa.  (BNDigital; Domínio público)}{PNLD0001-07.png}
% \imagem{No jornal A Noite tinha uma seção destinada à publicação de folhetins. (BNDigital; Domínio público)}{PNLD0001-08.png}
% \imagem{Manuscrito de 1919 do romance Clara dos Anjos, que foi publicado em capítulos da revista Souza Cruz em 1924. (BNDigital; Domínio público)}{PNLD0001-09.png}
% \imagem{Busto do escritor Lima Barreto na cidade do Rio de Janeiro: símbolo da importância que o autor trouxe para o tema da desigualdade racial. (Eugenio Hansen, OFS; CC-BY-SA-3.0)}{PNLD0001-10.png}
% \imagem{Ex-jogador Wladimir em campanha contra o racismo no futebol. (Edson Lopes Jr/ A2; CC BY-NC 2.0)}{PNLD0001-11.png}
% \imagem{Autor do livro "O que é racismo estrutural", o jurista faz um retrato do preconceito racial na sociedade brasileira. (Francisco Severo; CC-BY-SA-4.0)}{PNLD0001-12.png}
% \imagem{A "Lei do Feminicídio" foi aprovada em 2015, fruto de diversas manifestações de mulheres contra a violência machista. (Ramiro Furquim; CC BY-NC-SA 3.0)}{PNLD0001-13.png}
% \imagem{A farmacêutica Maria da Penha lutou por anos para que seu agressor (seu marido) fosse punido. (Neusa Cadore; CC-BY-2.0)}{PNLD0001-14.png}
...
% \marginnote{\includegraphics[width=5cm]{./images/PNLD0001-03.png}\\
% \textit{Foto do autor}}

\renewcommand{\abstractname}{Carta ao professor}
...
\marginnote{\includegraphics[width=5cm]{./images/PNLD0001-07.png}\\
\textit{Foto do autor}}
...
\marginnote{\includegraphics[width=5cm]{./images/PNLD0001-08.png}\\
\textit{Foto do autor}}
...
\marginnote{\includegraphics[width=5cm]{./images/PNLD0001-09.png}\\
\textit{Foto do autor}}
...
\marginnote{\includegraphics[width=5cm]{./images/PNLD0001-11.png}\\
\textit{Foto do autor}}
