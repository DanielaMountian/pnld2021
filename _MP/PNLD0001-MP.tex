...
\textit{Tempo estimado:} Duas a três aulas de 50 minutos para cada
crônica.
...
\begin{quote}
\textit{(Habilidades BNCC: EM13LGG401, EM13LGG402, EM13LP45, EM13LP47 e
EM13LP48)}
\end{quote}

\textit{Conteúdo:} Esta atividade tem como base as cônicas
...
\textit{Objetivos:} Apresentar e trabalhar junto aos alunos e alunas as
...
\textit{Justificativa:} O fenômeno da variação linguística está muito
...
\textit{Metodologia:} A leitura e compreensão dos textos são
...
2) Para a crônica {\textit{Coisas de ``mafuá''}}
...
\textit{Conteúdo:} Criação de grupos de estudo e laboratórios de criação
...
\textit{Objetivos:} Promover um trabalho de longo prazo, com
...
\textit{Justificativa:} De acordo com as diretrizes estipuladas pela
...
\textit{Metodologia:} A primeira parte do projeto consiste na
...
\textit{Tempo estimado:} Um semestre.
...
\begin{quote}
\textit{(Habilidades BNCC EM13LGG703; EM13LGG704; EM13LP16; EM13LP36 e
EM13LP44)}
\end{quote}

\textit{Conteúdo:} A partir dos contos \textit{\emph{A cartomante}} e
...
\textit{Objetivos:} Trabalhar, junto aos alunos e alunas do Ensino
...
\textit{Justificativa:} A \emph{Antologia de crônicas e contos de Lima
...
\textit{Metodologia:} Qualquer um dos dois contos selecionados para esta
...
\textit{Propostas de atividades 2}
...
\textit{Conteúdo:} A partir da crônica {\textit{Macaquitos}} e do
...
\textit{Objetivos:} A partir da leitura e análise dos textos literários
...
\textit{Justificativa:} Para o trabalho com um tema complexo como o
...
\textit{Metodologia:} Trabalhar com Literatura numa perspectiva mais
...
\def\labelenumi{\arabic{enumi})}
\item
  \textit{Tema: Denunciando a Violência contra as mulheres}
\end{enumerate}

\textit{(Habilidades BNCC EM13LGG703; EM13LGG704; EM13LP16; EM13LP36 e
EM13LP44)}

\textit{Conteúdo:} Na \emph{Antologia de crônicas e contos de Lima
...
\textit{Objetivos:} Objetiva-se com essa atividade despertar um olhar
...
\textit{Justificativa:} Apesar de todos os avanços e conquistas nas
...
\textit{Metodologia:} Usaremos como modelo a crônica {\textit{Lavar
...
\textit{Sugestões de referências complementares}

\textit{Lima Barreto -- \emph{De Lá Pra Cá} }
...
\textit{Lima Barreto \emph{-- Um grito brasileiro}. }
