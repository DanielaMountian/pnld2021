...
{\emph{Feiras e ``mafuás''}} e {\emph{No ``mafuá'' dos
...
principalmente em {\emph{Feiras e ``mafuás''}}, que apresenta um
...
Depois da leitura de {\emph{Feiras e ``mafuás''} e
{\emph{No ``mafuá'' dos padres}}, o professor ou professora pode
...
Para o trabalho centrado na crônica {\emph{Coisas de ``mafuá''}},
...
crônica {\emph{Coisas de ``mafuá''}} é muito próxima de
{\emph{Paulino e o ``mafuá''}}. Ambas se constituem de um ``texto
dialogado'', com linguagem simples, desenvolvimento curto e um tom de
humor. No entanto, em {\emph{Coisas de ``mafuá''}} existe algo de
...
com a crônica {\emph{Coisas do jogo do ``Bicho''}}, o uso da
