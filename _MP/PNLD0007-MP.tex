...
\SideImage{Tâmis Parron. Acervo pessoal do autor)}{PNLD0007-03}
...
\SideImage{Nina Simone foi uma artista que não separou a arte de seu papel político contestatório na sociedade racista de seu país, os \textsc{eua}. (Gerrit de Bruin; \textsc{cc} \textsc{by} 4.0)}{PNLD0007-18}
...
\SideImage{Luedji Luna busca em seu trabalho reconstruir os laços destruídos pelo sistema escravagista. (Marcelo Nava; \textsc{cc} \textsc{by}-\textsc{nc}-\textsc{nd} 2.0)}{PNLD0007-17}
...
\Image{Fuga em massa de escravos de Cambridge, Maryland, \textsc{eua}, 1857. (William Still; \textsc{cc}-\textsc{by}-\textsc{nc} 2.0)}{PNLD0007-04}
...
\SideImage{Carolina Maria de Jesus foi uma escritora brasileira conhecida pelo livro ``Quarto de despejo'' onde narra sua vida num morro. (Arquivo Nacional; Domínio Público.)}{PNLD0007-21}
...
%(Pacha J. Willka; \textsc{cc} \textsc{by}-\textsc{sa} 3.0)} {PNLD0007-19}
...
José de Alencar ao Imperador D. Pedro \textsc{ii} em defesa da escravidão. 
...
\SideImage{Em um campo de algodão na Carolina do Sul, \textsc{eua}. (Okinawa Soba/Flickr; \textsc{cc}-\textsc{by}-\textsc{nc} 2.0)}{PNLD0007-09.png}
...
\Image{Antigo mercado de escravos, Flórida, \textsc{eua}. (Okinawa Soba/Flickr; \textsc{cc}-\textsc{by}-\textsc{nc} 2.0)}{PNLD0007-10.png}
