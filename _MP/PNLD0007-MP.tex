...
\begin{comment}
WPA (associação de escritores em 1930, quebra da bolsa)
https://www.dropbox.com/home/PNLD/2021/LIVROS/MIOLOS/PROVISORIOS?preview=PNLD0007_hedra_wpanascidos_MIOLO.pdf
Representação gráfica https://www.youtube.com/watch?v=wtzg5uEpiOI
Para todos
----------
Utilizar a divisão de assunto da WPA
Comparar falas:
  Ex-estravizado em 1850, em 1890
  Ex-Escravizado falando para branco ou para negro
  Mulher/Homem
Economia (Artigo do P. Escott WPA)
Brasil x EUA 
  Brasil (plantation) fazendas maiores com 200 cativos
  EUA propriedade rural famliar com 4 a 5 escravos 
  Abolicionismo: Brasil, pouquíssimo regristros (Baquaqua)
  A favor da escravidão (José de Alencar)
    https://github.com/hedra-editora/alencar_cartas/blob/master/INTRO.tex
    - Pais novo
    - Pai = família (negro é de casa mas não ainda)
    - Economicamente não é viável
    - Nossa lingua é original, aceita tudo, estamos em formação
    - https://en.wikipedia.org/wiki/Mahommah_Gardo_Baquaqua
    - O mais próximo no brasil é o Manzano. 
    - Argumento econômico 
      https://twitter.com/andreinetto/status/1370341745985212420
    ...
    - Autobiografia do Gama (vendido pelo próprio pai)

Incluir depoimento e NOME dos ex-escravizados citados e fotografados na WPA

Preconceito linguístico; Língua de Eulália
\end{comment}
...
No final do século {XIX} havia, nos Estados Unidos das Américas, 
...
\SideImage{Paul D. Escott (Wake Forest University; Acervo pessoal do autor)}{PNLD0007-03.png}



\paragraph{Tema} % colocar
\paragraph{Conteúdo}
...
%   aos demais perfis produzidos pela turma, os alunos
%   produzirão uma série de \emph{podcasts} sobre as trajetórias de vida
%   das pessoas entrevistadas.
% \end{itemize}

% A primeira versão, se possível, deverá ser digitada no computador, com o auxílio de um
...
% perfil biográfico. Depois, proponha que os alunos releiam a sua produção e façam os
% ajustes e as reformulações que julgarem necessárias.
...
% publicados em uma plataforma de \emph{streaming}. Incentive os alunos a criar
...
% É possível enriquecer as gravações, utilizando \emph{softwares} de edição para
...
% sociais, plataformas de \emph{streaming} para distribuição digital de dados, ou
% mesmo no \emph{site} ou em um blog da escola.

% Caso não seja possível produzir os áudios, com todos os equipamentos eletrônicos 
% necessários, o mural com fotos dos entrevistados e uma simulação, em roda, 
% de um programa de rádio que comentaria as entrevistas, seguindo os roteiros escritos 
% pelos alunos também é outra sugestão para essa atividade proposta. 
...
\Image{Fuga em massa de escravos de Cambridge, Maryland, EUA,1857 (William Still; CC-BY-NC 2.0)}{PNLD0007-04.png}
...
\Image{A plantation ``Hermitage'' com as casas dos escravos aos fundos em Savannah, Geórgia, EUA, 1907. (John Tewell/Flickr; CC-BY-NC 2.0)}{PNLD0007-05.png}
...
\Image{Uma vez libertos, muitos dos ex-escravos e seus filhos não tinham para onde ir, Martha e seu filho Bob, Geórgia, EUA. (Okinawa Soba/Flickr; CC-BY-NC 2.0)}{PNLD0007-08.png}
...
\Image{Leilão e vendas de negros em Atlanta, Geórgia, EUA, 1864 (John Tewell/Flickr; CC-BY-NC 2.0)}{PNLD0007-07.png}
...
\Image{Uma família negra na Plantation ``Hermitage'', Savannah, Geórgia, EUA, por volta de 1907. (John Tewell/Flickr; CC-BY-NC 2.0)}{PNLD0007-06.png}
