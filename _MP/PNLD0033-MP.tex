...
\SideImage{Escultura de Patativa do Assaré, Fortaleza, Ceará. (Autoria Desconhecida; \textsc{cc}-\textsc{by}-\textsc{sa} 2.0)}{PNLD0033-03.png}
...
\Image{Literatura de Cordel. (Diego Dacal/Wikimedia Commons; \textsc{cc}-\textsc{by}-\textsc{sa} 2.0)}{PNLD0033-06.png}
...
\Image{Flor de mandacaru registrada em trilha na Bahia. (Wellscte/Wikimedia Commons; \textsc{cc}-\textsc{by}-\textsc{sa} 4.0)}{PNLD0033-08.png}
...
\Image{Xilogravura da Artista plástica Yolanda Carvalho (Rafael Nolêto/Wikimedia Commons; \textsc{cc}-\textsc{by}-\textsc{sa} 3.0)}{PNLD0033-10.png}
...
\Image{Município de Assaré em vermelho, 2006. (Raphael Lorenzeto de Abreu/Wikimedia Commons; \textsc{cc}-\textsc{by}-\textsc{sa} 3.0)}{PNLD0033-05.png}
...
\Image{Memorial Patativa do Assaré, em Assaré, Ceará. (Allan Patrick/Flickr; \textsc{cc}-\textsc{by}-\textsc{sa} 2.0)}{PNLD0033-04.png}
...
\Image{Ilustração da capa do cordel ``O \textsc{abc} da Cachaça'' (Thomas Fisher Rare Book Library/Flickr; \textsc{cc}-\textsc{by}-\textsc{nc}-\textsc{sa} 2.0)}{PNLD0033-07}
...
\Image{Capa de ``A Xilogravura Popular e a Literatura de Cordel'', 1985 (Thomas Fisher Rare Book Library/Flickr; \textsc{cc}-\textsc{by}-\textsc{nc}-\textsc{sa} 2.0)}{PNLD0033-09.png}
