...
\newcommand{\issnppub}{978-65-994304-2-8}
\newcommand{\issnepub}{978-65-994304-3-5}
...
muitas formas de narração em prosa, mas, a partir do século \textsc{xvii}, o
romance vai ganhando importância até se tornar, no século \textsc{xix}, a forma
...
séculos \textsc{xvi} e \textsc{xvii}, entretanto, aventuras como aquelas vividas por
...
superior do povo miúdo'',\footnote{\textsc{defoe}, Daniel. \emph{Robinson
...
Ao longo do século \textsc{xviii}, houve uma intensa discussão para saber se a
...
com o Período Moderno, após o século \textsc{xvi}.
...
\Image{Rota de Robinson Crusoé pelas montanhas dos Pirenéus (Alan Mattingly; \textsc{cc}-\textsc{by}-\textsc{sa} 4.0)}{PNLD0013-06.png}
...
\SideImage{Fotografia da Escultura de Alexander Selkirk, personagem que inspirou o livro \emph{Robinson Crusoé}, 2004. (Felipe Henríquez González; \textsc{cc}-\textsc{by}-\textsc{sa} 3.0)}{PNLD0013-05.png}
...
contexto de investigação que existiu no século \textsc{xvi}.
\BNCC{EM13LP01}
...
da vida dos exploradores marítimos do século \textsc{xvi}. Os naufrágios eram tão
...
uma pesquisa sobre o século \textsc{xvi} voltada a dois aspectos: a descoberta e
...
do livro lido, deixando uma marca de leitura para os
...
foi senhor de engenho na Bahia do século \textsc{xvii}, a Bahia em que circularam
...
xelins a um certo mestre Hackett.''\end{quote}\footnote{\textsc{azevedo}, Ana Maria de.
  ``Introdução'', em \textsc{cardim}, Fernão. \emph{Tratados da terra e gente do
...
pessoas.\footnote{\textsc{sousa}, Gabriel Soares de. \emph{Tratado descritivo
...
\textsc{xix}, circulou em cópias manuscritas largamente, pois informações que ele
...
\item
\emph{O náufrago} (\textsc{eua}, dir. Robert Zemecks, 2001)
...
como se fosse uma adaptação da história para o século \textsc{xx}.

\item
\emph{Na natureza selvagem} (\textsc{eua}, dir. Sean Penn, 2008)
...
\item
\emph{Robinson Crusoé} (\textsc{eua}, dir. Rod Hardy e George Miller, 1997)
...
\begin{enumerate}
\item
\emph{As Aventuras de Robinson Crusoé} (\textsc{eua}, dir. Robert F. Hill, 1922)

Seriado de 18 capítulos que narra a história de Robinson Crusoé.

\item
\emph{Lost} (\textsc{eua}, dir. J.J. Abrams, 2004)
