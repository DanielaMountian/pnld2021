...
\newcommand{\TituloLivro}{Zeppelin: algumas crônicas}
\newcommand{\Tema}{Ficção, mistério e fantasia}
\newcommand{\Genero}{Conto, crônica e novela}
\newcommand{\imagemCapa}{./images/PNLD0004-01.png}
\newcommand{\issnppub}{978-65-88934-01-2}
\newcommand{\issnepub}{978-65-88934-04-3}
...
O livro \emph{Zeppelin: algumas crônicas} consiste em uma antologia de crônicas, 
...
para o todo. Leia a seguir sobre a habilidade da \textsc{bncc} abordada.
...
exemplo. Leia a seguir sobre a habilidade da \textsc{bncc} abordada.
...
\paragraph{Tema} Aproximações e diferenças da crônica com outros gêneros em prosa. Leia a seguir sobre a habilidade da \textsc{bncc} abordada.
...
pode ser transformado em um outro gênero literário. Leia a seguir sobre a habilidade da \textsc{bncc} abordada.
...
exercitados. Leia a seguir sobre a habilidade da \textsc{bncc} abordada.
\BNCC{EM13LP47} % Sarau
...
\item
  ...
  Instagram e Twitter, por exemplo. Leia a seguir sobre a habilidade da \textsc{bncc} abordada. 
  \BNCC{EM13LP53} % Produzir e publicar na internet
...
fundamental na busca pela identidade nacional, um dos pressupostos defendidos pelo movimento. Por isso, esta atividade pode contribuir não apenas para a área de língua portuguesa, mas também para outras áreas das ciências humanas e sociais aplicadas. Leia a seguir sobre a habilidade da \textsc{bncc} abordada.
\BNCC{EM13CHS205} %Regionalismos

\Image{Bloco de Maracatu em Olinda (PE), uma forma de expressão da cultura popular brasileira. (Tetraktys; \textsc{cc}-\textsc{by}-\textsc{sa}-3.0)}{PNLD0004-12.png}
...
\begin{enumerate}
\item
Com a participação de professores da área de Ciências Humanas, estabeleça uma conversa inicial sobre o que
...
popular na era da cultura de massas. Leia a seguir sobre a habilidade da \textsc{bncc} abordada.
...
\paragraph{Conteúdo} Discussão e reflexão, com o apoio de professores
da área de Ciências Humanas, sobre as relações entre
...
perspectiva teórica quanto histórica. Leia a seguir sobre a habilidade da \textsc{bncc} abordada.
...
\SideImage{O modernismo brasileiro na arquitetura: a Catedral de Brasília projetada por Oscar Niemeyer. (Mario Roberto Durán Ortiz; \textsc{cc}-\textsc{by}-\textsc{sa} 4.0)}{PNLD0004-10.png}


\Image{"O Abaporu": obra de Tarsila do Amaral é ícone do Modernismo Brasileiro. (Cesar Cardoso; \textsc{cc}-\textsc{by} 2.0)}{PNLD0004-11.png}
...
\Image{Exposição com obras do Museu d’Orsay, de Paris, trazem quadros com estilo Modernista europeu. (Danilo Verpa; \textsc{cc}-\textsc{by} 2.0)}{PNLD0004-13.png}


\Image{A influência do movimento modernista europeu no trabalho dos modernistas brasileiros pode ser vista na experimentação de formas e técnicas. (Danilo Verpa; \textsc{cc}-\textsc{by} 2.0)}{PNLD0004-14.png}
...
\item
  ...
  modernização que ele atravessou? Leia a seguir sobre a habilidade da \textsc{bncc} abordada.
...
\paragraph{Conteúdo} Criação de um mapa interativo junto de
professores de Geografia, a partir dos dados
...
espaço. Leia a seguir sobre a habilidade da \textsc{bncc} abordada.
\BNCC{EM13CHS204}
...
notas, imagens, músicas, filmes, entre outros elementos gráficos. Leia a seguir sobre a habilidade da \textsc{bncc} abordada. Leia a seguir sobre a habilidade da \textsc{bncc} abordada.
...
dos quais o discurso histórico foi construído. Leia a seguir sobre a habilidade da \textsc{bncc} abordada.
...
\item
Junto com os professores de História, estabeleça uma discussão com os alunos sobre as
...
\emph{Macunaíma}, lançado em 1928, e \emph{Amar, verbo intransitivo}, 
...
\Image{A Biblioteca Mário de Andrade, localizada no centro de São Paulo, cujo nome traz memória ao legado do autor. (Gabriel Fernandes; \textsc{cc}-\textsc{by}-\textsc{sa}-4.0)}{PNLD0004-15.png}
...
\item
  ...
  Com vasto material de arquivo, esse documentário retrata a herança do período ditatorial de Getúlio Vargas -- momento em que a posição de Mário de Andrade no Departamento de Cultura foi abruptamente revogada. 
\item
  \emph{A marvada carne} (1985), direção de André Klotzel;

   O filme segue a trajetória de um caipira que vai do campo para a cidade de São Paulo.
   A narrativa traz um contraponto entre passado e contemporaneidade.

\item
  \emph{Macunaíma} (1969), direção de Joaquim Pedro de Andrade;

  Inspirado na obra mais importante de Mário de Andrade, é uma clássica adaptação para o cinema 
  e está na lista da Abraccine dos 100 melhores filmes brasileiros de todos os tempos.

\item
  \emph{Tempos modernos} (1936), direção de Charles Chaplin;

  O clássico filme de Charles Chaplin pode ser um motor para uma interessante discussão sobre Modernidade.

\item
  \emph{Mário de Andrade -- Reinventando o Brasil} (2001), da série
  ``Mestres da Literatura'', produzida pelo Ministério da Educação;

  Episódio da série que apresenta a vida e a obra de grandes escritores brasileiros.

  \item
  \emph{AmarElo -- É tudo pra ontem} (2020), direção de Fred Ouro Preto.

  O filme mostra a trajetória do rapper Emicida e sua apresentação no Theatro Municipal de São Paulo,
  que também foi palco da Semana de Arte Moderna de 1922.
...
\item
  ...
  Obra-prima do grupo Racionais MC's, o disco Sobrevivendo no Inferno traz elementos
 da crônica em suas letras, com relatos do cotidiano em São Paulo.

\item
  \emph{Perfil de São Paulo} (2000), Inezita Barroso;

  Percepções acerca de diferentes lugares da cidade São Paulo são o tema do disco de Inezita Barroso.

\item
  \emph{Macunaíma Ópera Tupi} (2008), Iara Rennó.

  Disco feito a partir da musicalização de trechos da obra original de Mário de Andrade
  e lançado no ano de comemoração dos 80 anos de \emph{Macunaíma}.
...
\item
  ...
  Rosseti Batista e Yone Soares de Lima;
    ...
    Catálogo da série \emph{Artes Plásticas} da Coleção Mário de Andrade, pertencente ao acervo do Instituto de Estudos Brasileiros da \textsc{usp}.

\item
  \emph{Coleção Mário de Andrade -- Religião e magia, música e dança,
  cotidiano} (2004), Marta Rosseti Batista.

O segundo catálogo da Coleção Mário de Andrade é fruto de longa pesquisa realizada no Instituto de Estudos Brasileiros da \textsc{usp} e revela aspectos pouco conhecidos da atuação do escritor paulista.
...
\item
  ...
  Endereço: \href{https://cronicabrasileira.org.br}{cronicabrasileira.org.br}

  O site possui um extenso arquivo de crônicas e surgiu a partir de 10 mil crônicas de recortes de jornais
 do acervo de Literatura do Instituto Moreira Salles.
...
\item
  \textsc{castro}, Moacir Werneck de. \emph{Mário de Andrade}: exílio no Rio.
...
\item
  \textsc{moraes}, Marcos Antonio de (org.). \emph{Correspondência de Mário de
...
\item
  \textsc{simas}, Luiz Antonio. \emph{Almanaque brasilidades: um inventário do
...
\item
  \textsc{souza}, Eneida Maria de; Cardoso, Marília Rothier. \emph{Modernidade
  toda prosa}. Rio de Janeiro: \textsc{puc}-Rio; Casa da Palavra, 2014. 
...
\item
  \textsc{tércio}, Jason. \emph{Em busca da alma brasileira}: biografia de Mário
  ...
  vida cultural e política brasileira da primeira metade do século \textsc{xx}. O
