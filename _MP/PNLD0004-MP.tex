...
% \Image{Casa em que morou Mário de Andrade no Largo do Paissandu. (Arquivo Nacional; Domínio Público)}{PNLD0004-04.png}
% \Image{Paulicéia Desvairada é um dos livros que originaram os contos presentes nessa antologia. (Biblioteca Brasiliana Guita e José Mindlin; Domínio Público)}{PNLD0004-05.png}
% \Image{Obra mais importante do autor, em publicação de 1928. (Biblioteca Nacional; Domínio Público)}{PNLD0004-06.png}
% \Image{Livro O Movimento Modernista, publicado em 1942. (Biblioteca Brasiliana Guita e José Mindlin; Domínio Público)}{PNLD0004-07.png}
% \Image{Fotografia de desenho de Mário de Andrade de 1928. (Arquivo Nacional; Domínio Público)}{PNLD0004-08.png}
% \Image{O Theatro Municipal de São Paulo foi palco da Semana de Arte Moderna de 1922. (Wilfredor; CC0)}{PNLD0004-09.png}
% \Image{O modernismo brasileiro na arquitetura: a Catedral de Brasília projetada por Oscar Niemeyer. (Mario Roberto Durán Ortiz; CC BY-SA 4.0)}{PNLD0004-10.png}
% \Image{"O Abaporu": obra de Tarsila do Amaral é ícone do Modernismo Brasileiro. (Cesar Cardoso; CC BY 2.0)}{PNLD0004-11.png}
% \Image{Bloco de Maracatu em Olinda (PE), expressão da cultura popular brasileira. (Tetraktys; CC-BY-SA-3.0)}{PNLD0004-12.png}
...
\Image{Mário de Andrade com 35 anos, em 1928. (Michelle Rizzo; Domínio Público)}{PNLD0004-03.png}
...
%BNCC EM13LGG101; EM13LGG703; EM13LGG301;  EM13LP50; EM13LP53
...
forma que ela demanda para que seja representada.
...
ser um bom material para romance e por quê. Quais elementos contidos no
...
%  BNCC EM13LGG101; EM13LGG301; EM13LP13; EM13LP46; EM13LP53)}
...
necessariamente, flertar com a comédia, não é nada disso, e sim que ela
tem a leveza do cotidiano simples que nos acompanha desde a hora que
...
ser uma espécie ``agência de caça-talentos'' literária, claro. Não que
...
\item
  ...
  intelectual''. Portanto, incentive também que eles realizem um
  trabalho de pesquisa exaustivo sobre o tema escolhido;
\item
...
áreas das ciências humanas e sociais aplicadas.
...
\SideImage{Livro O Movimento Modernista, publicado em 1942. (Biblioteca Brasiliana Guita e José Mindlin; Domínio Público)}{PNLD0004-07.png}
...
%  EM13LGG101; EM13LGG201; EM13LP01; EM13LP33; EM13CHS106; EM13CHS206)}
...
ocorrem os fatos ou que sejam referenciados, apresentando informações
...
delimitada geometricamente de um lugar, mas uma resultante das dinâmicas
...
espaço, de aplicação de políticas voltadas para o desenvolvimento do
lugar, de transformação das redes de sociabilidade e de descoberta de
identidades que esses espaços produzem.

Mário de Andrade não foi apenas um viajante, mas um turista aprendiz. Na
...
para compreender esses mecanismos de busca e construção das identidades
e culturas.
...
\item
Os estudantes devem anotar as referências dos locais e marcá-la no
mapa, que pode ser tanto virtual quanto físico. A partir da crônica, o
...
%EM13LGG101; EM13LGG201; EM13LP01; EM13LP33; EM13CHS101; EM13CHS501)}
...
chamado \emph{Jogo de cena}, em que atrizes, entre famosas e não
...
diversas publicações mandando seus textos curtos ao sabor das
inquietações cotidianas. Embora o caráter lúdico de quem queria
``brincar de escrever'', ele não se furta a expor as tensões de uma
sociedade ricamente diversa social e culturalmente, mas com problemas
arraigados lá no fundo, que se refletem nos conflitos de classe e nas
relações de poder.
...
intitula, também foram resgatados os textos em que Mário de Andrade atua
também como crítico, falando sobre pintura, literatura, artes plásticas
e patrimônio artístico e cultural. São textos publicados no ``Suplemento
