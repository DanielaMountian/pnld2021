...
linguístico. Veja ness link da Wikipedia, \href{https://pt.wikipedia.org/wiki/Palavras_japonesas_de_origem_portuguesa}{palavras japonesas de origem 
portuguesa} e fale sobre a presença portuguesa no Japão, iniciada
em 1542. 
Leia a seguir sobre a habilidade da BNCC abordada.
\BNCC{EM13LGG401} %Língua

Observer com os educandos, principalmente nos contos `'Ogin'' e ``O mártir'',a relação
...
sua preferência e peça para categorisá-los como por exemplo
...
a mangá, e-zines, eventos de cosplay etc.
Veja a BNCC a seguir sobre a habilidade abordada.
\BNCC{EM13LP21} %Avaliação de conteúdo pop e opinião


Em seguida, apresente a eles a série de mangás 
japoneses \href{https://pt.wikipedia.org/wiki/Bungo_Stray_Dogs}%
{Bungo Stray Dogs}, escrita por 
...
E leia também \href{https://bungakunerd.medium.com/ryunosuke-akutagawa-de-escritor-solit%C3%A1rio-a-mafioso-desalmado-b9f9dd1f5f39}%
{esse interessante artigo no Medium assinado por ``Mai''} 
sobre a relação do mangá com o autor de Rashômon. 
...
de um perfil no instagram cujo nome faça uma referênia ao autor para que 
...
\href{https://bit.ly/3foPErG}{fandom.com}. Divulgação.}{PNLD0009-25}
...
elementos da literatura de  Ryunosuke Akutagawa 
