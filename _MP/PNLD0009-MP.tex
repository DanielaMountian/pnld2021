...
\BNCC{EM13LP29} %Partes
 ...
 %Sofia: A imagem abaixo PNLD0009-20 não consta como domínio público ou CC que 
% possa ser usado para fins reprodutivos, parece ser um still do filme.
...
%Sofia: A imagem abaixo PNLD0009-20 não consta como domínio público ou CC que 
% possa ser usado para fins reprodutivos, podemos usar divulgação?
