...
\textit{Apocalypto}. Direção: Mel Gibson (Estados Unidos, 2006).
...
\textit{Distancia}. Direção: Sergio Ramírez (Guatemala, 2012)
...
\textit{Onde nasce o sol -- Donde Nace el Sol}. Direção: Elías Jiménez (Guatemala, 2013)
...
\textit{Guatemala: Coração do mundo Maia}. Direção: Ignacio Juansolo e Luis Ara (Guatemala, 2019)
...
\href{https://artsandculture.google.com/project/exploring-the-maya-world}{O Mundo dos Maias}
...
\href{https://www.learner.org/series/invitation-to-world-literature/popol-vuh/popol-vuh-map-timeline}{Linha do Tempo de Popol Vuh}
...
\textsc{cereja}, William Roberto. \textit{Ensino de literatura: uma proposta
...
\textsc{coelho}, Nelly Novaes. \textit{Literatura infantil: teoria, análise,
...
\textsc{eliade}, Mircea. \textit{Cosmos e história: o mito do eterno retorno}.
...
\textsc{lajolo}, Marisa. \textit{Literatura: ontem, hoje, amanhã}. São Paulo:
Editora Unesp, 2018.
...
\textsc{lajolo}, Marisa; \textsc{zilberman}, Regina. \textit{A formação da leitura no
...
\textsc{lévi-strauss}, Claude. \textit{Mito e significado}. Coimbra: Edições 70,
2007.
