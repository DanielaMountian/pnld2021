...
\newcommand{\issnppub}{978-65-89705-01-7}
\newcommand{\issnepub}{978-65-89705-02-4}
...
Em \emph{Tipógrafo, poeta e editor}, coletânea de oito poemas em cordel de sua
...
Em ``Como Lampião entrou na cidade de Juazeiro'', poema que abre a coletânea,
...
respeito ao líder religioso, mantenha"-se desarmado. Já no poema ``A sorte de uma meretriz'', 
acompanhamos a história de uma bela moça
...
do Brasil. 
\SideImage{Retrato de João Martins de Athayde (Memórias do Cordel; \textsc{cc}-\textsc{by}-\textsc{sa}
2.0)}{PNLD0045-03.png}
...
\Image{Literatura de Cordel (Diego Dacal/Wikimedia Commons; \textsc{cc}-\textsc{by}-\textsc{sa}
2.0)}{PNLD0045-05.png}
...
\Image{Capa do cordel ``História de Roberto do Diabo'' (Fundação
...
Nolêto/Wikimedia Commons; \textsc{cc}-\textsc{by}-\textsc{sa} 3.0)}{PNLD0045-10.png}
...
Oliveira Júnior/Wikimedia Commons; \textsc{cc}-\textsc{by}-\textsc{sa} 3.0)}{PNLD0045-04.png}
...
Mesmo sem frequentar a escola, o poeta andava com uma carta de \textsc{abc} no chapéu,
...
``\emph{Valorizar e fruir as diversas manifestações artísticas e culturais, das
  ...
  produção artístico-cultural\footnote{\textsc{brasil}. Ministério da Educação. Base
...
Fisher Rare Book Library/Flickr; \textsc{cc}-\textsc{by}-\textsc{nc}-\textsc{sa} 2.0)}{PNLD0045-09.png}
...
\item \textsc{andrade}, Cláudio Henrique Salles; \textsc{silva}, João
  Melquíades Ferreira; \textsc{barros} Leandro Gomes de. \textit{Feira de versos: poesia
...
\item \textsc{nascimento}, Lourgeny Damasceno do. \textit{A importância da
  ...
  ao Departamento de Artes da \textsc{unb}. Brasília: 2011. (Disponível em:
