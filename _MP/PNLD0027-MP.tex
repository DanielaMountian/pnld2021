...
de São Paulo. Entre suas obras publicadas, estão situados os livros \emph{O Coletivo
Aleatório} (2001), \emph{O Diário Perdido do Jardim Maia} (2008) e, a principal delas,
\emph{Crônicas do Crack} (2017).

\emph{Crônicas do crack} reúne vinte relatos colhidos pelo autor no contato com os dependentes. 
...
atendimentos médicos, porém não visando somente a intervenção médica. A intenção é de 
observar o mundo do dependente químico, tanto em suas “viagens” como em suas relações 
sociais, considerando o ambiente pelo qual transita e até mesmo os estados de loucura.
...
doutor para conseguir uns trocados. Segundo o médico, o dependente se aproxima muito 
daqueles autores e pensadores que vivenciaram o movimento literário do romantismo, por
sempre estar buscando a viagem, a loucura extremada e o flerte com o perigo e com a morte.
``O canto da noia'', que abre o livro, surgiu de uma visita feita à Cracolândia, na Zona 
Leste de São Paulo, que acabou sendo uma consulta coletiva a céu aberto. Já para escrever 
``Sobrevivente de Troia", no último capítulo, foi através de atividades com grupos de 
teatro que o autor elaborou o material. Ao final de cada crônica, seguem, em itálico, 
...
Pos isso, é esperado que os textos aqui presentes possam ajudar a combater o estereótipo 
construído em torno das pessoas que consomem crack e outras drogas. A obra defende que esses 
indivíduos têm sentimentos, uma vida anterior ao vício e estão, muitas vezes, dentro de um 
contexto desfavorável.

Esperamos que as indicações propostas aqui sejam muito úteis no trabalho, certamente muito 
...
lembrando dela.
\SideImage{Luis Marra (Autor Desconhecido; Acervo do autor)}{PNLD0027-03.png}
...
\Image{O livro aborda a temática da dependência química a partir da perspectiva do indivíduo  (Marco Gomes; CC BY 2.0)}{PNLD0027-04.png}
...
\subsection{Pré"-leitura}
\SideImage{O crack inibe a recaptação da dopamina alterando o funcionamento dos neurônios (Autor Desconhecido; Domínio Público)}{PNLD0027-05.png}
