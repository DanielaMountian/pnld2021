...
aqueles que vivem nas regiões das diversas ``cracolândias'' existentes na cidade
...
\paragraph{Metodologia}
	...
	no www.youtube.com/watch?v=47NIEsOO6qA}{PNLD0027-11}
		...
		deu para a \textsc{tv} Estadão, \href{https://www.facebook.com/209792265728043/videos/1772581939449060}{disponível nesse link}. E que leia, se possível, a entrevista dada à revista Cult \href{https://rotacult.com.br/2017/08/dr-luis-marra-fala-sobre-o-livro-cronicas-do-crack/}{disponível aqui}. Em seguida:
...
da perspectiva do indivíduo (Marco Gomes; \textsc{cc}-\textsc{by} 2.0)}{PNLD0027-04.png}
...
\begin{enumerate}
	...
	O professor pode recorrer ainda ao vasto relatório elaborado pelo \textsc{ipea} para 
...
\SideImage{Substâncias químicas e o corpo humano (Drug Disposal; Domínio Público)}{PNLD0027-06.png}
...
\SideImage{Dependente químico mostrando cachimbo  (Marco Gomes; \textsc{cc}-\textsc{by} 2.0)}{PNLD0027-08.png}
...
\Image{Moradores de rua no centro de São Paulo (Marco Gomes; \textsc{cc}-\textsc{by} 2.0)}{PNLD0027-07.png}
...
\Image{Dependentes químicos na região da Cracolândia (Luciana Marinho/Flickr; \textsc{cc}-\textsc{by} 2.0)}{PNLD0027-09.png}
...
\Image{Entorno da Cracolândia. Bairro da Luz, São Paulo-\textsc{sp} (Marco Gomes; \textsc{cc}-\textsc{by} 2.0)}{PNLD0027-10.png}
