...
\paragraph{Tema} Primeiras crônicas do crack. 
...
vida de algumas pessoas e como elas chegaram ao crack. 
...
ao se tornar um usuário de drogas. Nessa primeira atividade, 
que antecede a leituras dos contos literários sobre usuários de droga
reais, é necessário abordar o assunto a partir de conceitos e
preconceitos. Veremos na metologia a seguir que os alunos serão 
convidados a assistir um breve documentário produzido pelo 
próprio autor, com o intuido de mostrar o rosto e 
a fala de algumas pessoas sobre o significado da droga 
do ponto de vista especificamente delas. Consideramos essa 
atividade fundamental como pré-leitura, uma vez que 
os textos propostos não vão tratar da droga em si, mas 
...
\paragraph{Metodologia}
	...
	no Youtube no endereço \href{https://www.youtube.com/watch?v=47NIEsOO6qA}{youtu.be/47NIEsOO6qA}}{PNLD0027-11}
		...
		autor. O filme pode ser visto no seguinte link:
		\url{https://www.youtube.com/watch?v=47NIEsOO6qA}

		O filme tem cerca de 24 minutos e consiste em uma série de demoimentos sobre
		a droga, o uso dela, como os usuários se envolveram com ela, 
	...
	\begin{enumerate}
		...
		\item Após o filme, proponha que escrevam individualmente sobre algum caso de 
		amigo ou conhecido que já sofrera por conta de drogas. 

		\item Ao final, pergunte se alguém gostaria de ler a sua redação e completar o relato, 
		e abra para discuções. Tente abordar os seguintes tópicos. (a) O que sabemos sobre 
		o crack? (b) O usuário de crack é um marginal ou um marginalizado? Qual a diferença
		entre esses conceitos? (c) Por fim, o que foi mais significativo na fala dos 
		usuários do documentário?  
