...
\item
Em seguida, apresente aos estudantes o conceito de \emph{journaling} -- como é conhecida, 
...
\begin{enumerate}
\item
Como atividade de pré"-leitura, sugere"-se a exposição de matérias gráficos
...
de Mark Twain \emph{Diários de Adão e Eva} tanto na parte 1 --``Fragmentos do diário de Adão'' 
quanto na parte 2 -- ``Diário de Eva''.
