...
\newcommand{\colaborador}{\textbf{Vicente Castro} é uma pessoa incrível e vai
...
\SideImage{Estátua de Afrodite exposta no Museu Arqueológico de Nápoles. É uma cópia da estátua grega de 310-200 A.C. (Museu Arqueológico de Nápoles; CC-BY 3.1)}{PNLD0054-11.png}
...
\begin{quote} \textsc{COELHO}, Nelly Novaes. Literatura infantil. \emph{Teoria,
...
\begin{quote} \textsc{BOSI}, Ecléa. \emph{Memória e sociedade.} São Paulo: Companhia
...
\begin{quote} \textsc{BOURCIER}, Paul. \emph{História da dança no ocidente.} São Paulo:
