...
modos de pensar e agir de certa parcela da sociedade do século \textsc{xix} na
Europa.
...
e nítida presença de um inimigo.''\footnote{\textsc{stevenson}, Robert Louis.
...
\paragraph{Tema} O século \textsc{xix} e o desenvolvimento científico
...
longo do século \textsc{xix}, porque muitas questões morais se impunham em seu
...
século \textsc{xix}. Crenças religiosas, que consideram o corpo um objeto
...
científicos do século \textsc{xix}. 
...
mesma série temática, como \emph{De volta para o futuro} (\textsc{eua}, Dir.
Robert Zemeckis, 1985) e \emph{A invenção de Hugo Cabret} (\textsc{eua}, Dir.
...
\textsc{todorov}, Tzvetan. \emph{Introdução à literatura fantástica}. 2ª ed. São
...
\textsc{nunes}, Benedito. ``A visão romântica'', em \emph{O romantismo},
...
\textsc{bosi}, Alfredo. \emph{História concisa da literatura brasileira}. 33ª ed.
...
\textsc{netto}, Marcus Vinícius Rezende Fagundes. ``O médico, o analista e o
...
\textsc{pinheiro}, Carlos Eduardo Brefore. ``Da literatura ao teatro: a eterna
...
\emph{Fragmentado} (\textsc{eua}, Dir. M. Night Shyamalan, 2016)
...
\textsc{stevenson}, Robert Louis. \emph{O estranho caso do Dr. Jekyll e Mr.
...
nessa edição, dois artigos sobre psicologia experimental do século \textsc{xix},
``A personalidade multiplex'' e ``As desintegrações do ego''.

%Códigos da \textsc{bncc}
%
