...
a Missão de Pesquisas Folclóricas, a fundação do \textsc{sphan}, Serviço do
Patrimônio Histórico e Artístico Nacional, atual \textsc{iphan}, e o projeto da
...
\SideImage{Mário de Andrade (Hotsite Missões de Pesquisas Folclóricas, fotógrafo: Luís Saia; \textsc{cc} \textsc{by}-\textsc{nc}-\textsc{nd} 2.0)}{PNLD0005-21.png}
...
%\textsc{bncc}-\textsc{pos}-\textsc{leitura}
...
do antigo \textsc{sphan} (Serviço do Patrimônio Histórico e Artístico Nacional),
atual \textsc{iphan} (Instituto do Patrimônio Histórico e Artístico Nacional).
...
expande, atribuindo novos sentidos à experiência musical\footnote{Tomamos
  ...
  cordel. Cf. \textsc{ferreira}, Jerusa Pires. \textbf{Cavalaria em Cordel: o
...
modernismos que faço são pro Brasil''\footnote{\textsc{andrade}, Carlos Drummond
...
também pode ser adquirido em formato de \textsc{cd} nas lojas virtuais do \textsc{sesc}
São Paulo.
...
\item \textsc{souza}, Eneida Maria de; \textsc{cardoso}, Marília Rothier. \emph{Modernidade
