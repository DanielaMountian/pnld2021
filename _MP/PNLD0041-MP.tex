...
\SideImage{Casa Ludwig Tieck de 1819 a 1842, Saxônia, Alemanha (Lupus in Saxonia; \textsc{cc}-\textsc{by}-\textsc{sa} 4.0)}{PNLD0041-05.png}
...
\Image{O gazebo, 1861 (\textsc{mdz} München; Domínio Público)}{PNLD0041-06.png}
...
\SideImage{Ilustração para a peça lírica ``Vida e morte de Santa Genoveva'' (Gbi.bytos/Wikimedia Commons; \textsc{cc}-\textsc{by}-\textsc{sa} 4.0)}{PNLD0041-07.png}
...
\Image{Ilustração d'une Berceuse de Tieck (canção de ninar) por Ludwig Richter (Gbi.bytos/Wikimedia Commons; \textsc{cc}-\textsc{by}-\textsc{sa} 4.0)}{PNLD0041-10.png}
