...
%\SideImage{Casa em que morou Machado de Assis no Cosme Velho (Acervo Digital da Biblioteca Nacional; Domínio Público)}{PNLD0026-04.png}
...
cadeira de número 7 da \textsc{abl}, em 2018;
...
linguagem do século \textsc{xxi}. Além disso, esse grupo também deve ser capaz de
...
o contexto e a linguagem do século \textsc{xxi}. Também deve estar disponível, ao
...
princípio de que o enredo de ``A Cartomante'' aconteceu no século \textsc{xxi},
...
brasileira do século \textsc{xix}, fosse ela mais ou menos explícita. O que
...
\item a importância da \textsc{mpb} engajada, nos festivais da canção;
...
argumentações orais (descritas a seguir, nos itens de \textsc{xx} a XX): quais
...
consolida, culminando com a Revolução Industrial do século \textsc{xix}, as obras
...
reprodutibilidade técnica}. São Paulo: L\&\textsc{pm}, 2018.

Este ensaio clássico de Walter Benjamin é fundamental para estudar a
mercantilização da obra de arte no contexto do século \textsc{xix}. No conjunto
...
\textsc{xvi} ao \textsc{xviii}, foi publicado em 2019 -- e mesmo que não se refira
