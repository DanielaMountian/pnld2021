...
Sob o pôr do sol é uma coletânea de contos publicada no final do século 
\textsc{XIX} pelo irlandês Bram Stoker, o mesmo que escreveu o famoso Drácula 
alguns anos depois. Obra da juventude do autor, já estão presentes nela todos 
os elementos fundamentais da literatura gótica que aparecerão em Drácula em 
expressão máxima. 

Vale lembrar que o gótico é um movimento que surge em resposta aos argumentos 
do Iluminismo francês no século \textsc{XVIII}, estes, que buscavam a valorização 
do conhecimento racional tal qual faziam os clássicos da antiguidade ocidental. 
É por isso que veremos, nestes contos, sob muitas formas, alegorias de oposições 
entre Bem e Mal, racional e irracional, enfim, os tão bem conhecidos maniqueísmos 
da ética cristã, seguida pelo próprio autor em sua vida pessoal, tudo recheado 
por um imaginário de fantasias e paisagens ora assustadoras, ora apaixonantes.
