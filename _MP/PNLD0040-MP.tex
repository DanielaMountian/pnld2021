...
Passando por temas históricos, humorísticos e heroicos, trazendo um tom fabulesco, ou um tom direto, grande parte dessas histórias foram inspiradas por acontecimentos na vida do autor.
...
de vícios e obsessões. Esta foi a última fase do autor, que revelou Strindberg mais anti-dogmático e dando asas à fantasia.Várias peças de câmara são deste momento: por exemplo ``A tempestade'', ``Pelicano'', 
...
\paragraph{Conteúdo} Pesquisa sobre os contos de fadas de tradição europeia e sobre a mitologia de matriz nórdico-escandinava. Criação de uma história em quadrinhos inspirado em heróis e divindades escandinavos.
...
\SideImage{Ilustração de 1850 representa Odim, uma das mais importantes divindades nórdicas. (Otto Henrik Wallgren; Domínio Público)}{PNLD0040-08.png}


\SideImage{Desenho a lápis representa Odim, o deus da guerra segundo a mitologia escandinava (Victor Villalobos; CC-BY-SA 4.0)}{PNLD0040-09.png}
...
\paragraph{Tema} \emph{Sagas} e os movimentos artísticos do século XIX.
...
e estimular a relação entre os textos e os principais movimentos artísticos do século XIX.

\paragraph{Justificativa} É interessante promover uma associação entre a a leitura de \emph{Sagas} 
e pesquisa feita pelos alunos na atividade de pré"-leitura, com o intuito de aprimorar
...
acerca dos principais movimentos artísticos-literários do século XIX.
...
\paragraph{Tema} A Suécia do século XIX
...
\item Para essa atividade, recomenda-se que, juntamente com os professores de humanidades, seja
...
uma apresentação para os demais colegas.
...
elementos que compõem a temática infantil, no caso de \emph{Sagas}, muito
...
\subsection{Por que ler \emph{Sagas}?}
...
a inspiração, como em Hesíodo ou subHomero.
