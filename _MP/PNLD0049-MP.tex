...
ano na Rússia e pelas festividades (Natal e Páscoa), como nota Mountian.\footnote{\textsc{mountian}, Daniela. Paratexto. In: \textsc{tolstói}, Aleksei. \emph{A infância de Nikita} (livro de estudante). São Paulo: Kalinka, 2021. Daqui em diante, citado como: (\textsc{mountian}, 2021). Quando a referência não vem descrita em nota de rodapé na primeira ocorrência, a descrição completa se encontra na Bibliografia Comentada.} Portanto, a memória literária não se quer precisa
...
fossem esquecidos\emph{. Isso era muito maçante}'' \footnote{\textsc{tolstói}, Aleksei. /emph{A infância de Nikita} (livro de estudante). Sâo Paulo: Kalinka, 2021, p. 51, grifo nosso. Daqui em diante, citado como (\textsc{tolstói}, 2021).} Caso o trecho tivesse usado o discurso direto,
...
São questões que se referem à habilidade da BNCC a seguir:
\BNCC{EM13LP07}

Trechos em que a voz de Nikita e do narrador coincidem permeiam toda a
obra. Na pág. 11: ``Arkádi Ivánovitch era um homem insuportável: sempre se
...
Leia a seguir sobre a habilidade da BNCC relacionada com a atividade:
...
Acima, a habilidade da BNCC ligada a esta seção.
...
Conheça a habilidade da BNCC pertinente à proposta:
...
Acima, temos a habilidade da BNCC relacionada à seção.
...
Aqui está a habilidade da BNCC envolvida:
...
A seguir, a habilidade da BNCC abordada:
...
\marginnote{\footnotesize\textbf{PARA LER}\\ Populismo no país adotou estratégias terroristas; movimento foi responsável por atentado que matou o tsar Alexandre \textsc{ii}. \href{https://www1.folha.uol.com.br/esporte/2018/07/falando-russo-populismo-no-pais-adotou-estrategias-terroristas.shtml}{Folha de S. Paulo}. (10/07/2018)}
...
Adiante, apresentamos a habilidade da BNCC que será desenvolvida:
...
\href{https://www1.folha.uol.com.br/esporte/2018/07/falando-russo-papai-noel-usa-casaco-de-peles-e-treno-com-cavalos-na-russia.shtml}{``Papai Noel Russo usa casaco de peles e trenó com cavalos''}}
...
Acima, está a habilidade da BNCC abordada.
...
Segue a habilidade da BNCC relacionada:
...
Acima, a habilidade da BNCC envolvida
...
Conheça a habilidade da BNCC relacionada:
...
Leia a habilidade da BNCC que será desenvolvida:
...
Veja a habilidade da BNCC abordada:
...
Acima, temos a habilidade da BNCC envolvida.
...
Trata da trajetória e revelância do escritor e tradutor Boris Schnaiderman, que foi um dos responsáveis
em difundir a literatura russa no Brasil. É o filme sugerido para o cineclube da atividade II de pré"-leitura.
...
A série conta sobre o fim da dinastia Románov e sobre o início das revoltas populares na Russía do século \textsc{xx}.
...
\item\textsc{gúzeva}, A, \item \emph{O `outro Tolstói' em 5 obras imperdíveis!}. 26/01/2018. 
\href{https://br.rbth.com/cultura/79816-o-outro-tolstoi-em-5-obras}{br.rbth.com/cultura}{\emph{Russia Beyond
The Headlines.}
...
Aborda a didatização da Memória Literária no concurso da Olimpíada de Língua Portuguesa.
