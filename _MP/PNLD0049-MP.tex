...
% \newcommand{\imagemCapa}{PNLD0049-01.png}
\newcommand{\issnppub}{---}
\newcommand{\issnepub}{---}
...
\marginnote{\includegraphics[width=5cm]{./images/PNLD0049-08.png}}
...
\marginnote{\includegraphics[width=5cm]{./images/PNLD0049-04.png}}
...
\marginnote{\includegraphics[width=5cm]{./images/PNLD0049-09.png}}
...
\marginnote{\includegraphics[width=5cm]{./images/PNLD0049-05.png}}
...
\marginnote{\includegraphics[width=5cm]{./images/PNLD0049-10.png}}
...
\textsc{bernardini}, Aurora Fornoni. \emph{Aulas de Literatura Russa.} São Paulo:
Kalinka, 2018.

\emph{Encouraçado Potemkin}, \emph{O.} Dir. Serguêi Eisenstein, 1925,
Rússia.

\textsc{frank}, Anne. Diário de Anne Frank. São Paulo: Círculo do Livro, 2013.

\textsc{goldman}, Wendy. \emph{Mulher, Estado e Revolução}. São Paulo: Boitempo,
2014.

\textsc{górki}, Maksim. \emph{Infância.} São Paulo: Abril, 2010.

\textsc{moisés, massaud}. \emph{Dicionário de termos literários}. São Paulo:
Cultrix, 2004

\textsc{mountian}, D. Paratexto. \emph{A infância de Nikita.} São Paulo: Kalinka,
2021.
...
\textsc{schneider}, Graziela (org.). \emph{A Revolução das Mulheres.} São Paulo:
Boitempo, \emph{2017.}

\textsc{tolstói}, Aleksei. \emph{A infância de Nikita.} São Paulo: Kalinka, 2021.

\textsc{tolstói}, Aleksei Nikoláievitch. Prefácio de V.Scherbina. \emph{Sobranie
sotchinenii v desiati tomakh. Tom 1. Tchudaki. Povesti i rasskazi
1908-1911}. Moscou: Goslitizdat, 1958.

\textsc{velasco}, Tiago Monteiro. \emph{Escritas de si contemporâneas: uma
...
\textsc{woolf}, Virginia. \emph{Um teto todo seu.} São Paulo: Tordesilhas, 2017.

\section{Bibliografia comentada}

\textsc{mountian}, Daniela; \textsc{perpetuo}, Irineu; \textsc{simone}, Lucas. ``Falando Russo''.
...
\textsc{figes}, Orlando. \emph{Uma história cultural da Rússia.} São Paulo:
...
França, Itália, \textsc{eua}, República Tcheca) --- Há um trecho do filme que
...
\textsc{marcuschi}, Beth. \emph{A escrita do gênero memórias literárias no espaço
...
\textsc{cavalcanti}, Jasilene Lucena; Martins, Iara Ferreira de Melo.
...
\textsc{guimarães}, Diana Ribeiro; Rafael, Edmilson Luiz. \emph{Componentes
