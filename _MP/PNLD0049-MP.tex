...
ano na Rússia e pelas festividades (Natal e Páscoa), como nota Mountian.\footnote{\textsc{mountian}, Daniela. Paratexto. In: \textsc{tolstói}, Aleksei. \emph{A infância de Nikita} (manual do professor). São Paulo: Kalinka, 2021. Daqui em diante, citado como: (\textsc{mountian}, 2021). Quando a referência não aparece em nota de rodapé na primeira ocorrência, a descrição completa se encontra na Bibliografia Comentada.} Portanto, a memória literária não se quer precisa
...
fossem esquecidos\emph{. Isso era muito maçante}'' \footnote{\textsc{tolstói}, Aleksei. \emph{A infância de Nikita} (manual do professor). São Paulo: Kalinka, 2021, p. 51, grifo nosso. Daqui em diante, citado como (\textsc{tolstói}, 2021).} Caso o trecho tivesse usado o discurso direto,
...
obra. Na p.\,13: ``Arkádi Ivánovitch era um homem insuportável: sempre se
...
pessoa ao revelar os pensamentos de Nikita. Ou entre as páginas 22 e 23
...
\emph{Palavra, ele a viu}.'' Ou, ainda, na p.\,25 (grifo nosso): ``A
...
(\textsc{tolstói}, 2021, p. 149). A partir desse dia, o pássaro se deixou
...
A partida do pássaro ``pode remeter à posterior partida de Nikita para o colégio e acentua a transitoriedade da vida, que é evidenciada o tempo todo na obra'', como observa
Mountian (2021, p. 211). A narrativa estabelece estreita ligação
...
Jeltúkhin, sem tirar nem pôr'' (\textsc{tolstói}, 2021, p. 197).
...
natureza e pelas estações do ano'' (\textsc{mountian}, 2021, p. 211). A
...
cinzento e ventoso'' (\textsc{mountian}, 2021, p. 212).
...
(\textsc{tolstói}, 2021, p. 12). O tédio com que Nikita tem as lições de
...
entre os armários'' (\textsc{tolstói}, 2021, p. 68).
...
\SideImage{Alexandre \textsc{ii} (1855-1881), imperador russo que decretou o fim do regime de servidão (1861). Foto do fim dos anos 1870 (Wikipédia; Domínio público).}{PNLD0049-06}
...
\marginnote{\footnotesize\textbf{\textsc{para ler}}\\ ``Populismo no país adotou estratégias terroristas''; movimento foi responsável por atentado que matou o tsar Alexandre,  \textsc{ii}, \emph{Folha de S. Paulo}. \ref{https://bit.ly/3mQNxi7}  Acessado em 14/04/2021.}
...
\marginnote{\footnotesize\textbf{\textsc{para ver}}\\``Servo'' (\emph{Kholop}/ \emph{Son of a rich}, \textsc{rus}, 2019, Comédia): um mauricinho ultrapassa todos os limites e seu pai
...
``Papai Noel Russo usa casaco de peles e trenó com cavalos'', 
\emph{Folha de S. Paulo}. \oldhref{https://bit.ly/32sd9Zz} Acessado em 14/04/2021.}
...
ilha da Terra do Fogo'' (\textsc{tolstói}, 2021, p. 91). Acontece que o protagonista mora
...
novela, ``embora seu conteúdo se afaste, especialmente nos capítulos
publicados em Paris, das tendências pedagógicas que surgiram no governo bolchevique'', como nota Mountian (2021, p. 205).
...
\item \emph{O Pracinha de Odessa}. Dir. Luis Felipe Labaki, 2013. \href{https://www.youtube.com/watch?v=cXGSb7dsWo8}{Canal USP}.
...
Localizado em São Petersburgo, na Rússia, é um dos maiores museus de arte do mundo. Em seu site, é possível fazer uma visita virtual e explorar o museu com uma visão de 360º.

\item \href{https://www.russianhistorymuseum.org/}{Museu de História da Rússia}

Site com extenso arquivo sobre a história da Rússia, possui visitas online e uma biblioteca virtual.
\end{itemize}
...
Lucas. ``Falando Russo'', 2018. \href{https://www1.folha.uol.com.br/especial/2018/falando-russo//\#20}{\emph{Folha de S. Paulo}}.
...
2012. Disponível em:
\href{http://www.gelne.com.br/arquivos/anais/gelne-2012/Arquivos/\%C3\%A1reas\%20tem\%C3\%A1ticas/Lingu\%C3\%ADstica\%20aplicada/Diana\%20e\%20Edmilson\%20-\%20COMPONENTES\%20ENSIN\%C3\%81VEIS\%20DA\%20MEM\%C3\%93RIA\%20LITER\%C3\%81RIA.pdf}{gelne.com.br}.
...
2, número 1, p. 47-73, julho 2012. \href{http://www.cadernos.cenpec.org.br/cadernos/index.php/cadernos/article/view/92}{cadernos.cenpec.org.br}.
