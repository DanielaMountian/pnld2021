...
\Image{Depredação da sede do Sindicato dos Metalúrgicos do Rio de Janeiro, em 1964. Arquivo Nacional/Fundo Correio da Manhã; Wikipedia; \textsc{cc}-\textsc{by}-\textsc{nc}.}{PNLD0053-11}
...
\Image{Anúncio do \textsc{ai}-5, noticiado pelo Jornal Última Hora; Acervo Arquivo do Estado/Domínio público; Jornal Última Hora.}{PNLD0053-04}
...
Esse primeiro grupo de habilidades buscas estimular o desenvolvimento de algumas habilidades da \textsc{bncc}, entre as quais destacamos a de relacionar o texto, tanto na produção quanto na recepção, com suas condições de produção e contexto de circulação. 
...
\Image{Artistas protestam contra a ditadura militar em fevereiro de 1968. Na imagem, Tônia Carrero, Eva Wilma, Odete Lara, Norma Bengell e Cacilda Becker; Arquivo Nacional/Fundo Correio da Manhã. Autor desconhecido; Wikipedia; \textsc{cc}-\textsc{by}-\textsc{nc}.}{PNLD0053-10}
...
\Image{Manifestação das Diretas Já em Brasília, diante do Congresso
Nacional. 23 de abril de 1983. Agência Brasil; Wikipedia; \textsc{cc}-\textsc{by}-\textsc{nc}.}{PNLD0053-09}
...
\item No capítulo 2, intitulado ``Trinta anos antes'', temos a prisão de
  estudantes do \textsc{ita}, o Instituto Tecnológico da Aeronáutica, onde
  trabalha Durval.
\end{itemize}
...
entrevista à revista \emph{\textsc{ihu} Online}, ligada à Unisinos, universidade
...
\SideImage{Manifestantes simulam o método de tortura conhecido como pau de arara em Brasília; Wikipedia; \textsc{cc}-\textsc{by}-\textsc{nc}.}{PNLD0053-06}
...
O capítulo dois do livro menciona a prisão de estudantes do \textsc{ita}, o
...
paulista.
\Image{Navio Raul Soares, ca. 1926. Domínio público/Wikipedia. \textsc{cc}-\textsc{by}-\textsc{nc}.}{PNLD0053-05}
...
exemplo, o \textsc{ita}, em São José dos Campos, o Porto de Santos, o apartamento
...
importante que todos se engajem nesse processo, pois a produção de verbetes é uma das habilidades da \textsc{bncc} que a atividade deve estimular.
...
República em 1985, com Tancredo Neves e José Sarney, ambos do \textsc{pmdb}, como
...
\Image{Ulisses Guimarães; Wikipedia; \textsc{cc}-\textsc{by}-\textsc{nc}.}{PNLD0053-08}
...
o \textsc{sus}, e a maioria das crianças deixava a escola muito antes de chegar
ao ensino médio.

A retomada desse cenário deve ser entendida como a abertura de um
caminho para a compreensão desse passado.
\SideImage{Monumento Tortura Nunca Mais, no Recife. Foto de Marcusrg. Wikipedia/\textsc{cc} \textsc{by} 2.0.}{PNLD0053-07}
...
Os relatórios da \textsc{cnv} são o mais completo trabalho realizado pelo Estado
...
romancista da ditadura''. \textsc{uol}, 03/07/2020. Disponível em
