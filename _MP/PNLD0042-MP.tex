...
\SideImage{Retrato de Pedro I (1672-1725) (Arkhangelskoye Palace; Domínio Público)}{PNLD0042-07.png}
...
\subsubsection{Similitudes e diferenças de Brasil e Rússia}
...
\subsubsection{Retomando a atividade 2: um periódico do século XIX}
...
\subsubsection{Pesquisa sobre o sistema de ranques de Pedro I}
...
\item \href{http://www.fiocruz.br/bibsp/cgi/cgilua.exe/sys/start.htm?sid=107}{Biblioteca de Saúde Pública da Fiocruz}

Site com vasto arquivo de artigos, livros, revistas e teses acadêmicas sobre saúde pública. Pode ser um material interessante para
a atividade II de pós"-leitura.
