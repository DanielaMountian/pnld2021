...
\textbf{Objetivos:} Apreciar junto aos alunos e alunas o gênero
literário ``crônica'' a partir dos textos \emph{\textbf{A carroça dos
cachorros}} e \emph{\textbf{As enchentes}.}
...
\protect\hypertarget{_Hlk61884264}{}{}Ex. 1) Crônica: \emph{\textbf{A
...
Ex. 2) Crônica: \emph{\textbf{As enchentes}}
...
\textbf{Conteúdo:} Esta atividade tem como base as cônicas
\emph{\textbf{Coisas do jogo do ``Bicho''}} e \emph{\textbf{Coisas de
...
\textbf{Justificativa:} O fenômeno da variação linguística está muito
...
\textbf{Metodologia:} A leitura e compreensão dos textos são
...
\def\labelenumi{\arabic{enumi})}
\item
  Para a crônica \emph{\textbf{Coisas do jogo do ``Bicho''}}
\end{enumerate}
...
2) Para a crônica \emph{\textbf{Coisas de ``mafuá''}}
...
\emph{\textbf{Feiras e ``mafuás''}} e \textbf{\emph{No ``mafuá'' dos
...
principalmente em \emph{\textbf{Feiras e ``mafuás''}}, que apresenta um
...
- Depois da leitura de \textbf{\emph{Feiras e ``mafuás''}} e
\emph{\textbf{No ``mafuá'' dos padres}}, o professor ou professora podem
...
Para o trabalho centrado na crônica \emph{\textbf{Coisas de ``mafuá''}},
...
crônica \emph{\textbf{Coisas de ``mafuá''}} é muito próxima de
\emph{\textbf{Paulino e o ``mafuá''}}. Ambas se constituem de um ``texto
dialogado'', com linguagem simples, desenvolvimento curto e um tom de
humor. No entanto, em \emph{\textbf{Coisas de ``mafuá''}} existe algo de
...
com a crônica \emph{\textbf{Coisas do jogo do ``Bicho''}}, o uso da
...
\textbf{Objetivos:} Promover um trabalho de longo prazo, com
...
\textbf{Justificativa:} De acordo com as diretrizes estipuladas pela
BNCC para a criação de atividades que promovam a articulação entre áreas
do conhecimento, os \textbf{Grupos} se constituem como
...
\textbf{Laboratórios} \emph{supõem atividades que envolvem observação,
...
Os \textbf{Laboratórios} se constituem como uma etapa posterior e podem
...
\textbf{Conteúdo:} A partir dos contos \textbf{\emph{A cartomante}} e
\emph{\textbf{O homem que sabia javanês}}, elaborar estratégias e
...
\textbf{Objetivos:} Trabalhar, junto aos alunos e alunas do Ensino
...
\textbf{Justificativa:} A \emph{Antologia de crônicas e contos de Lima
...
\def\labelenumi{\arabic{enumi})}
\item
  Para o conto \textbf{\emph{A cartomante}:}
\end{enumerate}
...
dia, \textbf{\emph{A cartomante}} pode tranquilamente figurar como um
...
imediatamente ao final de sua leitura. No texto \emph{\textbf{A
...
encontramos em \emph{\textbf{A cartomante}}, o escritor poder conseguir
...
sofreram esse processo de ampliação. São eles \emph{\textbf{Clara dos
Anjos}} e \emph{\textbf{Numa e a Ninfa}}. Inicialmente escritos no
...
semelhantes, por exemplo: \emph{\textbf{O Gambá}}, \emph{\textbf{A
barganha}}, \emph{\textbf{Milagre do Natal}} e \emph{\textbf{Quase ela
deu o ``sim''}}.

2) Para o conto \emph{\textbf{O homem que sabia javanês}}
...
\emph{\textbf{O homem que sabia javanês}} em quadrinhos, lançada pela
...
estipulamos para o trabalho em relação ao texto \emph{\textbf{A
...
de composição narrativa. O narrador de \textbf{\emph{O homem que sabia
...
- Tanto em \emph{\textbf{A cartomante}} quanto em \textbf{\emph{O homem
...
contextos sociais internos às narrativas: em \textbf{\emph{A
cartomante}} trata-se de uma família pobre, quase sem os recursos
mínimos para a sobrevivência; já em \textbf{\emph{O homem que sabia
...
\textbf{Conteúdo:} A partir da crônica \emph{\textbf{Macaquitos}} e do
conto \emph{\textbf{O Pecado}}, a atividade consiste em trabalhar junto
...
\def\labelenumi{\arabic{enumi})}
\item
  Para a crônica \emph{\textbf{Macaquitos }}
\end{enumerate}
...
\def\labelenumi{\arabic{enumi})}
\item
  Para o conto \emph{\textbf{O pecado}}
\end{enumerate}
...
e jurídicas, tais como: a \textbf{Lei nº 7.716} de 5 de janeiro de 1989
(conhecida como ``Lei Caó''); a \textbf{Lei 9.029} de 13 de abril de
1995; o \textbf{Estatuto da Igualdade Racial} (Lei nº 12288, de 20 de
julho de 2010), que estabelece as cotas raciais em diversas esferas da
atividade social e a \textbf{Lei 10.639} de 9 de janeiro de 2003, que
...
\textbf{Justificativa:} Apesar de todos os avanços e conquistas nas
...
população, como as pessoas LGBTQIA+, as etnias constituídas pelos povos
originários, os quilombolas.

\textbf{Metodologia:} Usaremos como modelo a crônica \emph{\textbf{Lavar
...
A crônica \emph{\textbf{Lavar a honra, matando?}} é um dos vários textos
...
Já no século XX, o jornalismo passa a ser uma empresa especializada, com
...
\textbf{Sugestões de referências complementares}

\textbf{Lima Barreto -- \emph{De Lá Pra Cá} }

Link: \url{https://www.youtube.com/watch?v=M4roOVqpotY}

A série ``de Lá Pra Cá'', produzida pela TV Escola, tem como objetivo
...
\textbf{Lima Barreto \emph{-- Um grito brasileiro}. }
...
SOBRINHO, Barbosa Lima. \emph{Os precursores do conto no Brasil}. Rio de
