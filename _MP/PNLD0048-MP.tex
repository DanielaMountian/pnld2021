...
\item
  ...
  pós-leitura;
\item
  a \textbf{Proposta de Atividades \textsc{ii},} com os mesmos objetivos e
...
\Image{Retrato de Machado de Assis, 1890 (Marc Ferrez; Domínio público)}{PNLD0048-03.png}
...
Evaristo à cadeira de número 7 da \textsc{abl}, em 2018;
...
\SideImage{Gravura de Francisco de Paula Brito  (Autor Desconhecido, Século \textsc{xix}. Pinto, Ana Flávia Magalhães. De Pele Escura e Tinta Preta: a imprensa negra do século \textsc{xix} (1833-1899). Mestrado. Universidade de Brasília, 2006; Domínio público)}{PNLD0048-05.png}
...
\SideImage{Morro do Livramento, Rio de Janeiro, onde Machado de Assis nasceu (a seta aponta no alto do canto direito a possível casa de nascimento), sem data. (\textsc{abl}; Domínio público)}{PNLD0048-04.png}
...
análise do que eles gostam -- canções, séries de \textsc{tv} ou de plataformas de
...
\item Grupo de alunos que redigirão o roteiro do programa de \textsc{tv}
...
\SideImage{Pintura ``O vampiro'' (1897) de Philip Burne-Jones (Philip Burne-Jones; Domínio público)}{PNLD0048-07.png}
...
\SideImage{Placa comemorativa para o clássico do cinema mudo Nosferatu (1922) em Wismar, na Alemanha. Partes do filme foram filmadas em Wismar. (J.H. Janßen; Domínio público)}{PNLD0048-08.png}

\SideImage{O vampiro Conde Drácula movendo-se como um lagarto ao longo da parede de seu castelo. Ilustração da capa de Holloway para a décima terceira edição do romance de Bram Stoker (Londres, William Rider and Son, 1919). (Holloway; Domínio público)}{PNLD0048-06.png}
...
\SideImage{Crepúsculo é um filme norte-americano de 2008, dirigido por Catherine Hardwicke, sendo o primeiro da saga, adaptado do primeiro livro de Stephenie Meyer (Flickr; Creative Commons \textsc{cc}-\textsc{by}-\textsc{sa} 2.0)}{PNLD0048-09.png}
...
\item entrevista para a imprensa escrita: baseando"-se no \textit{best"-seller} de
...
preparar um \textit{podcast} com uma entrevista com Rui de Leão, a respeito de
...
\SideImage{``Poética'' de Aristóteles é um conjunto de anotações de suas aulas sobre o tema da poesia e da arte em sua época. (Biblioteca da Universidade de Sidney; Domínio público)}{PNLD0048-10.png}

\item Em diálogo com os alunos, com apoio das disciplinas de Ciências Humanas, o professor deve apresentar as especificidades do discurso histórico, seus alcances e limites, sem
...
\item Depois desse levantamento, em diálogo com os professores de Ciências Humanas, tentar analisar o ponto comum a esses
...
respeito de saúde mental. O blog deve conter textos, vídeos e \textit{podcasts};
...
\subsection{``O Alienista'': entre insanidade e lucidez, fato e ficção}
...
pertence esse texto. Jean Pierre Chauvin, ao analisá"-lo na introdução
...
arte, humanizou os internos do Centro Psiquiátrico Nacional Pedro \textsc{ii},
...
\item\textit{A Cartomante}. Direção de Marcos Faria (1974).
...
\subsection{Panoramas da vida e obra de Machado de Assis}

\begin{itemize}

\item \textsc{bosi}, Alfredo et al. \textit{Machado de Assis}. São Paulo: Ática, 1982.
...
\item \_\_\_\_\_\_. ``Machado de Assis''. In: \_\_\_\_\_\_. \textit{História
...
\subsection{Sobre os contos e assuntos relacionados}

\begin{itemize}

\item \textsc{arbex}, Daniela. \textit{O Holocausto brasileiro}. Rio de Janeiro:
Intrínseca, 2019.
...
\item \textsc{boucinhas}, André Dutra. ``Machado de Assis e a (sua) Revolução
...
\item \textsc{foucault}, Michel. \textit{História da loucura}. São Paulo: Perspectiva,
1995.
...
\item \textsc{gama}, Vítor Castelões; \textsc{laurentino}, Werbson Azevedo. ``Machado de Assis:
a literatura fantástica no conto O Imortal''. In: \textit{Revista
Investigações}, Recife, v. 33, n. 1, p. 1"-11, 2020.

Análise disponível através \href{https://periodicos.ufpe.br/revistas/INV/article/view/241490}{deste link}, do fantástico no conto ``O Imortal'', a partir da obra de
Tzvetan Todorov, também indicada nesta bibliografia.

\item \textsc{gerlach}, Carmen Lúcia Cruz Lima. ``O Imortal de Machado de Assis''. In:
...
\item \textsc{gomes}, Roberto. ``O Alienista: loucura, poder e ciência''. In:
...
\textsc{xix} em ``O Alienista'', especialmente o vínculo entre ciência e poder.

\item \textsc{matrangano}, Bruno; \textsc{tavares}, Eneias. \textit{Fantástico Brasileiro: o
...
\item \textsc{sasse}, Pedro. ``A besta dentro de cada um: metamorfoses do vampiro na
...
\item \textsc{todorov}, Tzvetan. \textit{Introdução à literatura fantástica}. Trad.
