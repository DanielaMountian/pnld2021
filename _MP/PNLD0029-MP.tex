...
\subsection{Os impactos do covid. Leitura do texto \emph{O Amanhã não está à venda}, de Ailton Krekak}
...
\subsection{Redação de uma carta ao rei de Portugal durante a colonização}
...
\subsection{Minidocumentário sobre costumes de uma comunidade indígena próxima da sua cidade}
...
\subsection{Um painel e uma peça de teatro sobre as narrativas}
...
\subsection{Leitura de reportagem sobre a língua como fenômeno cultural}
