...
\Image{Mapa do território Yanomami no Brasil e Venezuela, 2012. (Wikimedia Commons; \textsc{cc}-\textsc{by}-\textsc{sa} 3.0)}{PNLD0029-05.png}
...
\Image{Mulheres Yanomami do lado amazônico. (Wikimedia Commons; \textsc{cc}-\textsc{by}-\textsc{sa} 3.0)}{PNLD0029-06.png}
...
\Image{Mulher Yanomami tecendo cesta, 1999. (Cmacauley; \textsc{cc}-\textsc{by}-\textsc{sa} 3.0)}{PNLD0029-07.png}
...
%Leitura do texto \emph{O Amanhã não está à venda}, de Ailton Krekak}
...
\subsubsection{A língua como fenômeno cultural}
  ...
  pesquisa linguística indígena, deram para o site \textsc{uol} falando sobre as
