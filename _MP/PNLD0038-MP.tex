...
O museu, localizado no Parque Ibirapuera, zona sul de São Paulo, reúne um
...
\begin{itemize}
\item
\textsc{adichie}, Chimamanda Ngozi. \textbf{Americanah}. São Paulo: Companhia
das Letras, 2014.
...
\item
\textsc{adichie}, Chimamanda Ngozi. \textbf{O perigo de uma história única}.
...
\item
\textsc{alexander}, Michelle. \textbf{A nova segregação}. São Paulo: Boitempo,
2018.
...
\item
\textsc{angelou}, Maya. \textbf{Eu sei por que o pássaro canta na gaiola}.
...
\item
\textsc{evaristo}, Conceição. \textbf{Olhos d'água}. Rio de Janeiro: Pallas,
2014.
...
\item
\textsc{horne}, Gerald. \textbf{O sul mais distante}. São Paulo: Companhia das
  Letras, 2010.
...
\item
\textsc{lee}, Harper. \textbf{O sol é para todos}. São Paulo: José Olympio,
2006.
...
\item
\textsc{marquese}, Rafael; \textsc{salles}; Ricardo (org.). \textbf{Escravidão e
...
\item
\textsc{mccullers}, Carson. \textbf{A convidada do casamento}. São Paulo: Novo
  Século, 2008.
...
\item
\textsc{northup}, Solomon. \textbf{Doze anos de escravidão}. São Paulo:
Penguin, 2014.
...
\item
\textsc{porter}, Regina. \textbf{Os viajantes}. São Paulo: Companhia das
  Letras, 2020.
...
\item
\textsc{stockett}, Kathryn. \textbf{A resposta}. Rio de Janeiro: Bertrand
Brasil, 2012.
...
\item
\textsc{stowe}, Harriet Beecher. \textbf{A cabana do pai Tomás}. São Paulo:
Carambaia, 2018.
...
\item
\textsc{walker}, Alice. \textbf{A cor púrpura}. São Paulo: José Olympio, 2009.
