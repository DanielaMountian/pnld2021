...
O objetivo é fornecer apoio pedagógico àqueles para quem 
...
Além disso, a obra destaca ainda a 
paisagem e as personagens próximas aos brasileiros, ainda que 
infelizmente não tenhamos tanta familiaridade com elas: a realidade 
amazônica e as culturas milenares dos povos indígenas do Brasil 
proporcionando uma mudança de visão na personagem como se pode ler na história.
...
% Atualidade do texto
\emph{Mare nostrum} é um texto atual, publicado em 2014, num gênero de ficção que se aproxima da ficção científica, esbarrando nos subgêneros da ficção metacientífica e psicocientífica. A ficção científica é um gênero pouco explorado na escola, mas de muita identificação com o universo do adolescente, principalmente por meio de produções audiovisuais estrangeiras. Pouco se menciona de ficção com caráter científico produzida e ambientada no Brasil.
...
\SideImage{O autor da obra, Fabio Atui. (Acervo do autor)}{PNLD0008-03.png}
