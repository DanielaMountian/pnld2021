...
\newcommand{\issnppub}{978-65-994481-1-9}
\newcommand{\issnepub}{978-65-994481-2-6}
...
\SideImage{Autorretrato do autor, de aproximadamente 1825 (Xavier de Maistre; Domínio Público)}{PNLD0046-04.png}
...
\Image{A temática do mergulho em seu próprio quarto também foi explorada por outros artistas, como Van Gogh em seu famoso quadro ``Quarto em Arles'', de 1888. (Museu do Van Gogh; \textsc{cc}-\textsc{by}-\textsc{sa} 2.0)}{PNLD0046-07.png}
...
\Image{Estátua em homenagem as irmãos Joseph e Xavier de Maistre, localizada no castelo de Chambéry, na França. (Florian Pépellin; \textsc{cc}-\textsc{by}-\textsc{sa} 4.0)}{PNLD0046-06.png}
...
%Sofia: tinha essa \textsc{bncc} no meio desse parágrafo: EM13LGG201
