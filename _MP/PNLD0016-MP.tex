...
uma ampla pesquisa, visando encontrar publicações abolicionistas, brasileiras
e estrangeiras, oferecidas em diversos gêneros e formatos.
%Sugerir exercícios práticos a partir da pesquisa dessas publicações. 
%Sugestão: semelhanças e diferenças no processo de abolição brasileiro e norte-americano.
De modo que o aluno possa ter contato com as diversas formas de abordar um determinado
...
%Texto fraco. Precisa ser adequado à atividade de leitura do texto.
...
%Ok, mas pode ser ressaltada na atividade a escrita sobre as contribuições de Luiz Gama.
...
Isso posto, sugere"-se, para a realização dessa atividade, buscar auxílio do
...
%Praticamente uma repetição da atividade anterior.
%Sugestão: abordar de forma interdisciplinar um estudo cartográfico das rotas de tráfico de escravos para fazer o paralelo com os outros países, como sugerido na próxima atividade. Outra opção para a atividade II é trazer a parte da luta antirracista presente no aprofundamento como sugestão de pesquisa prévia.
...
%Utilizar-se da história de Luiz Gama para aprofundar essa atividade. Exemplo: a questão da sua mãe ter sido deportada de volta ao continente africano.
