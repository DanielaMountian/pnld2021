...
A leitura de relatos acerca das vivências de ex"-escravizados
  ...
  partir de novas consultas a \emph{sites} confiáveis da Internet.
...
ligados à questão, que possam servir de base para a formulação da tese
...
desenvolver uma reflexão sobre o aspecto selecionado, verificando se
...
meio da pesquisa em livros e \emph{sites} da Internet, a turma,
