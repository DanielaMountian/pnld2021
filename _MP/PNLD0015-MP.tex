...
Livro estabelecido de um manuscrito novo. Fazer uma atividade 
...
Usar dicionários antigos: http://dicionarios.bbm.usp.br/pt-br/dicionario/1/gentio
...
\newcommand{\colaborador}{{Bruno Gradella, Vicente Castro} e Ana Lancman (edição).}
