...
Leia a seguir sobre a habilidade da \textsc{bncc} abordada.
  \SideImage{Mais de 200 lugares na Europa reivindicam ter o Cálice Sagrado: essa versão, o Cálice de Antioche, feito em prata, é do século \textsc{vi} e está em exibição no Museu Metropolitan em Nova York. (Metropolitan Museum of Art; Domínio Público)}{PNLD0006-09.png}
...
personagens d'\emph{A} \emph{Demanda do Santo Graal}. Leia a seguir sobre a habilidade da \textsc{bncc} abordada. 
% Resenha crítica 
...
época. 
\BNCC{EM13CNT105} % \textsc{chs} ciclo bioquímicos
...
pingentes, pinturas etc. Leia a seguir sobre a habilidade da \textsc{bncc} abordada.
...
\SideImage{Manuscrito Lancelot-Graal. (Biblioteca Nacional da França; Domínio Público)}{PNLD0006-03.png}
...
\SideImage{Manuscrito medieval em que há uma representação do Rei Arthur. Ele segura sua espada e um brasão com a figura da Virgem Maria e seu filho. (British Library; Domínio Público)}{PNLD0006-05.png}
...
\subsubsection{O cordel brasileiro, herdeiro das tradições ibéricas}
  ...
  espaço sertanejo. Leia a seguir sobre a habilidade da \textsc{bncc} abordada. 
\BNCC{EM13LP10}
...
\SideImage{Poeta Zé da Luz (1904-1965), à direita da foto. Fonte: Wikipedia. \textsc{cc}-\textsc{by}.}{PNLD0006-20.jpg}
