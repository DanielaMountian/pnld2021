...
\BNCC{EM13CNT303}
\BNCC{EM13CHS101}
\BNCC{EM13CHS102; EM13CHS106; EM13CHS401.}
...
\subsection{Sugestões de atividades complementares: relações dialógicas e intertextuais}
...
\textit{Camelot}. Direção: Joshua Logan (\textsc{eua}, 1967).
...
\textit{Em busca do cálice sagrado}. Direção: Terry Gilliam; ‎Terry
...
\textit{Excalibur}. Direção: John Boorman (\textsc{eua}, Reino Unido, 1981).
...
\textit{O nome da rosa}. Direção: Jean"-Jacques Annaud (Itália/ França/
Alemanha, 1986).
...
\textit{O sétimo selo}. Direção: Ingmar Bergman (Suécia, 1959).
...
\textit{Rei Arthur}. Direção: Antoine Fuqua (\textsc{eua}, 2004).
...
\textsc{barthélemy}, Dominique. \textit{A cavalaria: da Germânia Antiga à França do século \textsc{xii}}. Campinas: Editora da Unicamp, 2010.
...
\textsc{bradley}, Marion Zimmer. \textit{As brumas de Avalon}. São Paulo: Planeta Minotauro, 2018.
...
\textsc{goff}, Jacques Le. \textit{Heróis e maravilhas da Idade Média}. São
Paulo: Vozes, 2010.
...
\textsc{jung}, Emma; \textsc{von"-franz}, Marie Louise. \textit{A lenda do Graal}. São
Paulo: Cultrix, 1991.
...
\textsc{martins}, Mário. (1975). Alegorias, símbolos e exemplos morais da
...
\textsc{massardier}, Gilles. \textit{Contos e lendas da Europa medieval}. São
...
\textsc{megale}, Heitor. \textit{O jogo dos anteparos. A Demanda do Santo Graal: a estrutura ideológica e a construção da narrativa}. São Paulo: T. A.
Queiroz, 1992.
...
\_\_\_\_\_. \textit{A Demanda do Santo Graal}. São Paulo: Companhia de
Bolso, 2008.
...
\textsc{mongelli}, Lênia Márcia. \textit{Por quem peregrinam os cavaleiros de
...
\_\_\_\_\_.; \textsc{macedo}, José Rivair. \textit{A Idade Média no cinema}. São
...
\textsc{pastoreau}, Michel. \textit{No tempo dos cavaleiros da Távola Redonda}. São Paulo: Companhia das Letras / Círculo do Livro, 1989.
...
\textsc{pyle}, Howard. \textit{Rei Arthur e os cavaleiros da Távola Redonda}. Rio de Janeiro: Zahar, 2015.
...
\textsc{rougemont}, Denis de. \textit{História do amor no ocidente}. Rio de
...
\textsc{spina}, Segismundo. \textit{A cultura literária medieval}. São Paulo:
Ateliê, 1997.
