...
\SideImage{Heloísa Buarque de Hollanda é autora de ``Pensamento feminista brasileiro'' e organizadora do livro "As 29 poetas hoje'', lançado em 2021. (Produção Cultural no Brasil; \textsc{cc}-\textsc{by}-\textsc{sa} 2.0)}{PNLD0030-08.png}
...
\SideImage{A indiana Rupi Kaur é uma das responsáveis por trazer visibilidade para mulheres poetas através das redes sociais. (Baljit Singh; \textsc{cc}-\textsc{by}-\textsc{sa} 4.0)}{PNLD0030-09.png}
...
\paragraph{Metodologia}
  \SideImage{Alguns diretores do Cinema Novo: movimento cinematográfico brasileiro marcante nos anos 1960 e 1970 e que se destacou por sua crítica a desigualdade social e a Ditadura Civil-Militar. (Johnsmith22who; \textsc{cc}-\textsc{by}-\textsc{sa} 4.0)}{PNLD0030-12.png}
...
\Image{O fim da década de 1970 e começo de 1980 no Brasil foi marcado pelo movimento das Diretas Já, que reuniu milhares de pessoas nas ruas se manifestando a favor da volta das eleições. (Arquivo da Agência Brasil; \textsc{cc}-0)}{PNLD0030-10.png}
...
% \SideImage{O Teatro de Arena foi um dos mais importantes grupos teatrais brasileiros das décadas de 1950 e 1960. (Henrique Artuni; \textsc{cc}-\textsc{by}-\textsc{sa} 2.0)}{PNLD0030-13.png}

\SideImage{A obra ``Seja marginal, seja herói'' de Hélio Oiticica é um marco do movimento de cultura marginal, que passou a fazer parte do debate cultural brasileiro a partir do final de 1968. (Wally Gobetz; \textsc{cc}-\textsc{by}-\textsc{nc}-\textsc{nd} 2.0)}{PNLD0030-11.png}
...
\item
  ...
  \Image{Caetano Veloso no \textsc{iii} Festival da Música Popular (Arquivo Nacional; Domínio Público)}{PNLD0030-15.png}
...
ilustrações? Exemplares de livros ou fac-símile de manuscritos?
  \SideImage{Gilberto Gil e Nana Caymmi no \textsc{iii} Festival da Música Popular (Arquivo Nacional; Domínio Público)}{PNLD0030-14.png}
