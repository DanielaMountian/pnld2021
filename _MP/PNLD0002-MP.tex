...
\SideImage{Theatro Municipal do Rio de Janeiro (Elvis Boaventura; \textsc{cc}-\textsc{by}-3.0)}{PNLD0002-08.png}
...
Leia a seguir sobre a habilidade da \textsc{bncc} abordada.
\BNCC{EM13CHS102}
%\SideImage{Arco do Triunfo no Rio de Janeiro, final do século \textsc{XIX}. (Arquivo Nacional; Domínio Público)}{PNLD0002-05.png}
...
\item
Junto com os professores da área de Ciências Humanas, apresente e discuta com os alunos os aspectos
...
Ciência, do CEFET/\textsc{rj}, disponível no YouTube. Com participação dos
...
Leia a seguir sobre as habilidades da \textsc{bncc} abordadas. 
...
\item
Com o apoio de professores da área de Ciências Humanas, apresente e discuta com os alunos em sala de
...
\SideImage{Quadro ``Navio Negreiro'' de Johann Moritz Rugendas (1830) (Johann Moritz Rugendas; Domínio Público)}{PNLD0002-11.png}
...
\SideImage{A ``Lei do Feminicídio'' foi aprovada em 2015, fruto de diversas manifestações de mulheres contra a violência machista. (Ramiro Furquim; \textsc{cc}-\textsc{by}-\textsc{nc}-\textsc{sa} 3.0)}{PNLD0002-14.png}
...
\Image{Em ato público, mulheres denunciam feminicídio no \textsc{df} (Wilson Dias/Agência Brasil; \textsc{cc}-\textsc{by}-3.0)}{PNLD0002-15.png}
...
\SideImage{Busto de Júlia Lopes de Almeida, Lisboa (PESP/ Wikimedia; \textsc{cc}-\textsc{by}-\textsc{sa} 4.0)}{PNLD0002-04}
...
\item``100\% Feminista'', em \emph{Bandida} (2016), \textsc{mc} Carol.

\href{https://www.youtube.com/watch?v=W05v0B59K5s&ab_channel=McCarolOficial}{100\% Feminista}
da \textsc{mc} Carol canta a luta feminista 
...
\begin{itemize}
\item\textsc{borelli}, Ana. \emph{Rio de Janeiro Perdido e Recuperado}. Rio de Janeiro: \textsc{tix}
Editora, 2019.

A publicação reúne fotos e ilustrações de diversos acervos, como a Biblioteca Nacional, 
\textsc{mis} e Iphan, e retrata obras arquitetônicas que desapareceram da paisagem do Rio de 
...
\begin{itemize}
\item \textsc{labelle} -- Laboratório de estudos de literatura e cultura da \emph{Belle Époque}, 
disponível em: \href{http://labelleuerj.com.br/}{LABELLE}.

O site do \textsc{labelle} tem o intuito de reunir e organizar publicações sobre a literatura 
...
progresso. Rio de Janeiro: Mauad; \textsc{puc}-Rio, 2016. 
...
\item\textsc{berta}, Veronica. \textit{Ânsia Eterna}. São Paulo: \textsc{sesi}-\textsc{sp},
2018.
...
Ed. Niterói: \textsc{uff} -- Universidade Federal Fluminense, 1986.
...
espírito das roupas}.~\textit{Cadernos Pagu}~(22), Campinas"-\textsc{sp}, Núcleo
