...
podem propor um seminário ou aula conjunta sobre a história da cidade de Paris, com
ênfase nas mudanças ocorridas no tempo de Baudelaire. 

O foco do debate são as mudanças urbanas iniciadas pelo Barão de Haussmann (1808--1891)
(em francês, pronuncia-se /osmã/). Peça para que procurem 
modelos urbanísticos sobre a ``cidade jardim''. 

Sugira que procurem saber sobre três datas em especial. 
1830, 1848 e 1871, momentos em que a cidade foi varrida
por movimentos populares. 

Por fim, peça para fazerem uma breve pesquisa sobre a ideia de progresso. 
