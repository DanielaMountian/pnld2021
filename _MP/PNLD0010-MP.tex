...
Eis um exemplo de como o \textit{flâneur} e o \textit{dândi} aparecem em sua obra:
...
Peça também para pesquisarem as fotos de Félix Nadar, no site da 
...
XIX, em que os alunos decorem no máximo uma estrofes 
(conjunto de de linhas de um verso). Posteriormente,
...
Durante a leitura, proponha, uma atividade de escrita criativa 
baseada na deriva poética.
