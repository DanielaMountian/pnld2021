...
\Image{Charles Baudelaire em 1863. (Etienne Carjat; \textsc{cc}-\textsc{by} 2.0)}{PNLD0010-03.png}
...
\Image{Retrato de Baudelaire pintado por Émile Deroy, em 1844. (Émile Deroy; \textsc{cc}-\textsc{by}-\textsc{sa}-4.0)}{PNLD0010-05.png}
...
\Image{Estátua ``O Flaneur": um tipo social retratado pelo autor, que representa o caminhante de galerias de grandes cidades. (\textsc{pvt} Pauline; \textsc{cc}-\textsc{by}-\textsc{sa} 3.0)}{PNLD0010-07.png}
...
\Image{``Carnaval parisiense": a sensação de estar imerso na multidão na cidade é um dos assuntos tratados pelo autor.  (Anônimo; \textsc{cc}-\textsc{by}-\textsc{sa} 3.0)}{PNLD0010-10.png}
