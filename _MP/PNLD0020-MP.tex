...
\newcommand{\issnppub}{978-65-994484-1-6}
\newcommand{\issnepub}{978-65-994484-3-0}
...
\SideImage{Vídeo sobre o fluxo dos navios negreiros do século \textsc{xv} até o fim da 
escravidão nos \textsc{eua}. Captura de tela do vídeo. 
youtu.be/aMyg2Cmukmo}{PNLD0020-15.png}
...
\Image{``Dança no campo'' de Pierre"-Auguste Renoir, 1833. (Pintura localizada no Museu de Orsay, Paris; Domínio Público)}{PNLD0020-12}
\Image{``O beijo'' de Gustav Klimt, 1908. (Pintura localizada no museu do Palácio Belvedere, Viena; Domínio Público)}{PNLD0020-11}
\Image{``Pequeno senhor que eu amo'', de Julien de Villeneuve, 1840. (Pintura localizada no Museu de Aquitaine, Bordéus; Divulgação)}{PNLD0020-13}
\Image{``Namorados'', de Ismael Nery, 1927. (Coleção particular, Rio de Janeiro; Domínio Público)}{PNLD0020-14}
...
\SideImage{Publicação original do livro, em 1861. (Documenting the American South; Domínio Público)}{PNLD0020-09.png}
...
\SideImage{Retrato do senhor de escravos James Norcom (State Archives of North Carolina Raleigh, \textsc{nc}; CC0)}{PNLD0020-07.png}
...
\Image{Anúncio feito pelo senhor de Harriet, Norcom, com uma recompensa de 100 dólares para quem a capturasse. No cartaz, há uma descrição de sua aparência física e a explicação de ela havia fugido. Há também o aviso de que poderão sofrer penalidades os que a ajudarem em sua fuga. (State Archives of North Carolina Raleigh, \textsc{nc}; CC0)}{PNLD0020-05.png}
...
\SideImage{Casa onde morou Harriet Ann Jacobs, em Cambridge, Massachusetts. (Midnightdreary; \textsc{cc}-\textsc{by}-\textsc{sa}-3.0)}{PNLD0020-04.png}
...
\Image{Retrato de Harriet, desenhado com lápis grafite por Keith White em 1994. (State Archives of North Carolina Raleigh, \textsc{nc}; CC0)}{PNLD0020-06.png}
...
\Image{"Eu era propriedade da filha deles'' -- Harriet Jacobs. Essa foto, de uma menina escravizada cuidando da filha do senhor de escravos, mostra como crianças eram obrigadas a cuidar de outras crianças. (State Archives of Florida, Florida Memory; Domínio Público)}{PNLD0020-10.png}
