...
\paragraph{Metodologia}
   ...
   \begin{enumerate}
    \item 
    Para este primeiro momento, propomos a leitura do discurso de Sojourner Truth, ativista 
    negra estadunidense pelos direitos da mulher. Proferido na Convenção dos Direitos das Mulheres 
    em Akron, Ohio,
    Estados Unidos, em 1851, seu posicionamento foi inovador por, pela primeira vez, trazer à tona
    as demandas das mulheres não"-brancas, mais especificamente as negras ex"-escravizadas, 
    num contexto onde só tinham voz os homens negros do Sul e as mulheres brancas do Norte.
    A fala de Truth se dá logo após a de pastores que defendem a supremacia masculina em relação
    ao feminino, sob os argumentos de que Jesus tinha sido um homem e que a primeira mulher,
    segundo a Bíblia, fora uma pecadora.
    \item 
    ...
    Para isso, refaça a leitura do seguinte trecho:
    ...
    \item
    Num segundo momento da aula, após a discussão, o professor deve, à lousa, oferecer
    aos alunos algumas definições sobre o texto autobiográfico. Sugerimos a seguinte definição
    proposta pelo ensaísta francês Philippe Lejeune em seu livro \emph{O pacto autobiográfico},
    que sugerimos como base para a preparação das explicações sobre o gênero:

    ``narrativa retrospectiva em prosa que uma pessoa real faz de sua própria existência, 
    quando focaliza sua história individual, em particular a história de sua personalidade'' (p.16)
...
\subsection{Leitura}
 ...
 \paragraph{Justificativa} A feminista negra estadunidense bell hooks diz em seu livro
 \emph{Tudo sobre o amor} que este sentimento pode ser desencadeador de um processo 
 de emancipação de dores e medos, na construção de uma vida mais potente. O amor, neste
 sentido, é revolucionário. Se pensarmos na condição do escravizado, é evidente que este
 sentimento não poderia fazer parte de seu quotidiano. 
 No livro \emph{Nascidos na escravidão}, coletânea de entrevistas coletadas
 pelo Projeto Federal de Escritores estadunidenses com ex"-escravizados 
 na década de 1930, encontramos alguns relatos sobre este tema. Com bastante crueza,
 vemos que o amor não fazia parte da vida destes indivíduos, que comumente tinham seus
 corpos usados pelos senhores como objeto de prazer somente. E as mulheres eram
 os alvos principais. 
 ...
 \paragraph{Metodologia}
   \begin{enumerate}
    ...
    sua vida de escravizada. A partir das reflexões trazidas por bell hooks em \emph{Tudo sobre
    o amor}, o professor deve iniciar uma discussão em roda. 
...
\subsection{Leitura}
 ...
 \paragraph{Metodologia}
   \begin{enumerate}
    ...
    de Ismael Nery. Na primeira obra, o pintor francês, em 1840, representa 
