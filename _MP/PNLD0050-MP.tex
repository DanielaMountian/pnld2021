...
\marginnote{\footnotesize\textbf{PARA LER}\\ ``Aleksandr Nikoláievitch Afanássiev e o conto popular russo'': dissertação de mestrado de Flávia Cristina Moino, USP. \href:{https://bit.ly/32rU61v} (Acessado em 21/03/2021).}
...
\marginnote{\footnotesize\textbf{PARA LER}\\ 
``De calendários a batatas: 5 legados de Pedro, o Grande, para a Rússia'',\emph{Russia Beyond.} \href{https://bit.ly/3e65OnN} (Acessado em 14/04/2021).}
