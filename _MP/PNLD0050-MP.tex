...
%Habilidades BNCC EM13LP01; EM13LP46;EM13LP49
...
jovem preocupação e consciência social, até obras do séc. XX que mostram
...
(MOUNTIAN, 2021, p. 25); em ``Sobre como Kolka Pánkin viajou para o
...
literária''. (MOISÉS, 2004, p. 87) Recebeu várias acepções ao longo dos
séculos; passou por lendas orientais, parábolas bíblicas, novelas
medievais italianas, fábulas francesas até chegar ao século XIX e ganhar
...
avanço importante na segunda metade do século XVIII, no reinado de
Catarina II (1729--1796), como visto no prefácio do livro. Naquela
...
Narrativa dos anos passados}. Tese de doutorado (USP) de Lucas Simone
...
protagonizada por seres humanos.'' (MOISÉS, 2004, p. 337)
...
de Daniil Kharms, fundador de um coletivo de vanguarda chamado OBERIU
...
e se interessava pelo ocultismo e pela cabala'' (MOUNTIAN, 2021, p.
...
\url{https://namidia.fapesp.br/masha-e-o-urso-dancam-tico-tico-no-fuba-e-fazem-passeio-pelo-brasil-em-desenho-inedito-no-pais/200070}
}
...
(LEAR, 2016, p. 13) --- e ambos foram referência para Kharms. O termo
...
serviram-lhe de inspiração''. (LEAR, 2016, p. 17) Outro que parece
...
\begin{figure}[ht!]
\includegraphics[width=\textwidth]{./images/PNLD0050-06.png}
\end{figure}
...
%EM13LP16; EM13LP17; EM13LP18; EM13LP28;EM13LP29; EM13LP34; EM13LP45; EM13LP46; EM13LP52; EM13LP53;EM13LGG703
...
Como lemos no prefácio do livro (MOUNTIAN, 2021), a literatura
...
simples''. (\emph{apud} GOTLIB) Nossa coletânea não traz contos
...
\marginnote{\footnotesize\textbf{PARA LER}\\ ``Aleksandr Nikoláievitch Afanássiev e o conto popular russo'': dissertação de mestrado (USP) de Flavia Moino.\\
...
conturbado, já que as reformas institucionais do tsar Alexandre II nos
...
simples, sem excessos.'' (MOUNTIAN, 2021, p.19).
...
todos temiam e de algum modo respeitavam.'' (MOUNTIAN, 2021, p. 19).
...
endereço que nunca chegará...''. (MOUNTIAN, 2021, p.361) Os contos
...
(\emph{apud} GOTLIB, 2006, p. 27) em seu artigo ``Por falar em conto'':
...
imperceptíveis ou no que foi deixado de dizer'' (MOUNTIAN, 2021, p.21);
...
marcas de estilo. Em ``Primeira mágoa\emph{''} (1912), temos a história
...
\begin{figure}[ht!]
\includegraphics[width=\textwidth]{./images/PNLD0050-09.png}
\end{figure}

\begin{enumerate}
\setcounter{enumi}{3}
\item Simbolismo e outras tendências do início do século XX
\end{enumerate}
...
século XX. Com o interesse simbolista pelo mito e pelo folclore, muitos
...
No início do séc. XX, a escritora predileta das moças russas era Lídia
...
respeito dos críticos (MOUNTIAN, 2021, p.26) Tchárskaia enveredou por
...
do conto de Tolstói (1996, Serguei Bodróv, RUS, CAZ)}

\paragraph{Tempo estimado} Quatro a seis aulas de 50 minutos.

\subsection{Pós-leitura IV}

\paragraph{Tema} Oficina e sarau de minicontos.

%EM13LP20; EM13LP47; EM13LP53;EM13LP54
...
pessoas... Por um momento, fiquei unicamente com a imagem da imperatriz
...
existe uma história nesse guarda-chuva. (MÁRQUEZ, 2004 p.14-15)
\end{quote}
...
fim, só uma pessoa escreve a história (...) Porque é claro que as linhas
gerais da história podem ser elaboradas coletivamente, mas na hora de
escrever o roteiro, a tarefa tem de ser de um só''. (MÁRQUEZ, 1995,
p.13)
...
%EM13LP01; EM13LP02; EM13CHS203;EM13CHS603
...
para esse público. (MOUNTIAN, 2021, p. 12) Além disso, foi no fim do
século XVIII que surgiu este que é considerado o La Fontaine russo: Ivan
...
\begin{figure}[ht!]
\includegraphics[width=\textwidth]{./images/PNLD0050-11.png}
\end{figure}
...
\url{https://br.rbth.com/arte/historia/2017/08/29/de-calendarios-a-batatas-5-legados-de-pedro-o-grande-para-a-russia\_830562}
}
...
Cloro\emph{''} (1781) e ``Conto dо Tsarévitche Fеvei\emph{''} (1783),
que, ``sem viés nacionalista'', ressaltam valores universais, como
justiça e bondade, como observado no prefácio. (MOUNTIAN, 2021, p.11)
...
Grande} (Philip Martin, 2019, disponível no HBO GO), principalmente do
...
pelo tsar Alexandre II em 1861); à presença de Thomas Dimsdale (médico
...
poderiam ser apontados? Quem foi Ivan VI, o ``prisioneiro número 1'' de
Shlisselburg? E por que a relação de Catarina com o filho, Paulo, era
tão turbulenta? Como a política externa russa de Catarina II deu
...
%BNCC EM13LP01; EM13LP46; EM13CHS101;EM13CHS102; EM13CHS201;EM13CHS603

\paragraph{Conteúdo}
Análise da figura feminina, sobretudo a da mãe, na literatura russa ao
longo de um período que cobre desde o século XVIII ao início do XX.
...
\paragraph{Justificativa}
Ao longo do século XVIII, o aumento da indústria caseira ou doméstica
...
masculino{]} e os professores eram admitidos aqui'' (WOOLF, 2014, p.
...
filho em ``Primeira mágoa\emph{''} e a babá, do mesmo conto, que tinha
...
fugir em ``O prisioneiro do Cáucaso\emph{''} (1872); a assustadora Zoia,
em ``A filha do fabricante de caixões\emph{''} (1918), que tenta
esfaquear o herói, o qual foge para viver; a doente Nadiejda, cujo nome,
não por acaso, significa ``esperança'' em russo, de ``O
elefante\emph{'';} e a estudiosa Natália de ``A prova\emph{''} (1912).

Outra opção é trabalhar a autoria feminina. São três as autoras
representadas na coletânea: Catarina II, Lídia Tcharskaia e Lídia
...
\begin{figure}[ht!]
\includegraphics[width=\textwidth]{./images/PNLD0050-12.png}
\end{figure}
...
%BNCC EM13LP03; EM13LP50;EM13CHS203
...
mas também o de ``O elefante'' e de ``A pedrinha vermelha\emph{''}. Além
...
olhos, o bigode e a barba...''. A cena não por acaso é retomada no fim
do conto de Kuprin, quando Artô, o \emph{poodle}, é resgatado e
reencontra seu dono dormindo, o velho tocador de realejo:

\begin{quote}
(...) antes de ele recobrar os sentidos, o cachorro já lhe lambia, com
...
de poeira, e compreendeu tudo. (MOUNTIAN, 2021, p.271)
\end{quote}
...
frente. (MOUNTIAN, 2021, p.363). Além disso, a clara menção ao conto de
...
com ele e cruel para com os numerosos servos''. (BERNARDINI, 2018, p.
...
cadelinha, ele praticamente cometeu um suicídio... Vale notar que há uma
...
(2011, p. 54), no início do século XX, Iúri Tyniánov, um teórico russo,
inovou a compreensão do elemento paródico:

\begin{quote}
Tyniánov {[}...{]} pode ser considerado o precursor dessa abordagem,
...
tratada em ``Poodle branco'' e ``Vanka\emph{''}? Em ``Primeira mágoa'' e
...
(\emph{apud} PONTES, BETTA, 2020, p.128). Além disso, como escreve
Pelegrini (2003 \emph{apud} BETTA, PONTES, 2020, p. 130), a sociedade
...
dentro do caos), levando a inquietações do pensamento''. (REIS, 2013 p. 1)
...
(SILVA; SOUZA, 2016, p. 79; apud BETTA, PONTES, 2010, p. 132)
\end{quote}

As ilustrações de Fido, de traço forte, estão inseridas na
contemporaneidade por dialogarem com HQ, universo muito atraente para o
...
coletânea. Quanto à relação com HQ, Fido lembra que é espontânea:

\begin{quote}
É natural, porque trabalho muito com HQ. Boa parte da minha carreira foi
voltada para ilustrações, mas intercalada com HQs. E depois dessa
revolução tecnológica, com o fechamento de muitas revistas, a HQ ganhou
...
Ramos e Nunes (2013 apud BETTA, PONTES) descrevem o papel de uma
...
do conto em uma imagem. (NESTI, 2021)
\end{quote}
...
de fole que surge no conto de Catarina II, uma versão regional russa
...
proposição de Camargo (1998 apud BETTA, PONTES): representativa,
...
BERNARDINI, Aurora Fornoni. \emph{Aulas de Literatura Russa.}
\textbf{~}São Paulo: Kalinka, 2018.

BETTA, Thiago; PONTES, Rodolfo. \emph{A ilustração do conto infantil:
uma proposta para a educação literária imagética e paratextual na sala
de aula}. Literartes, n° 13, 2020, p.128-149

BOSI, Alfredo. ``Situação e forma do conto brasileiro contemporâneo''.
In: \emph{O conto brasileiro contemporâneo}. São Paulo: Cultrix, 1977.

CORTÁZAR, Julio. \emph{Valise de cronópio}. São Paulo: Perspectiva, 1993

GOLDMAN, Wendy. \emph{Mulher, Estado e Revolução}. São Paulo: Boitempo,
2014.

\emph{Catarina, a Grande} (Philip Martin, 2019, disponível no HBO GO).\\
KERSLEY, Sarah Rebbeca. \emph{Quatro poemas de Sérgio Capparelli}.
Cadernos de Literatura em Tradução, n°12, 2011.

LEAR, Edward. \emph{Conversando com varejeiras azuis}. São Paulo:
Iluminuras, 2016

\emph{Mágico de Oz, O.} Direção: Fleming, Victor. Estados Unidos: Loews,
1939.

MÁRQUEZ, Gabriel García. \emph{Como contar um conto}. Rio de Janeiro:
Casa Jorge Editorial, 2004.

MOISÉS, Massaud. \emph{A criação literária.} São Paulo: Cultrix, 2001

MOISÉS, Massaud. \emph{Dicionário de termos literários}. São Paulo:
Cultrix, 2004

MOUNTIAN, Daniela (Org.). \emph{Contos russos juvenis.} São Paulo:
Kalinka, 2021.

MOUNTIAN, Daniela. Prefácio. Paratexto. \emph{Contos russos juvenis.}
São Paulo: Kalinka, 2021.

MOUNTIAN, Daniela. \emph{A vanguarda dos livros russos infantis}. Curso
de inverno. USP/2020. Canal de Serviço de Cultura e Extensão FFLCH/USP):
\href{about:blank}{\emph{https://www.youtube.com/watch?v=2l4v9rkW6H4}}

NESTI, Fido. Entrevista telefônica concedida à Editora Kalinka para o
Manual do Professor de \emph{Contos Infantojuvenis Russos} em
10/02/2021.

PAIXÃO, Biana Alves da. \emph{A literatura infantil de Daniil Kharms:
tradição e modernidade}. Dissertação de mestrado. Universidade de São
Paulo, 2015.

\emph{Prisioneiro das Montanhas}. Direção: Bodrov, Serguei. Rússia,
Cazaquistão: AO Karavan, BGg Prodakchn\emph{,} 1996.

REIS, Ana Paola dos. A análise de imagens como método de pesquisa e
...
SOARES, Angélica. \emph{Gêneros Literários}. São Paulo: Ática, 2007.

URSO, Graziela Schneider (org.). \emph{A revolução das mulheres}. São
Paulo: Boitempo, 2002.
...
ANDRADE, Mário. de. ``Contos e contistas'' IN: \emph{O empalhador de
passarinho}. 3 ed. Brasília: INL, 1972, p. 5-8. --- Escrito a propósito
...
São Paulo: Brasiliense, 3ª ed., 1985. --- Benjamin nota que o jornal vem
...
CORTÁZAR, Julio. ``Alguns aspectos do conto''; ``Do conto breve e seus
arredores'' e ``Poe: o poeta, o narrador e o crítico''. In: \emph{Valise
de cronópio}. São Paulo: Perspectiva, 1993, p.147-163, p. 227-237 e
103-146. --- ``Alguns aspectos do conto'' é resultado de uma conferência
...
GOTLIB, Nadia. \emph{Teoria do conto}. São Paulo: Ática, 2006. --- A
autora situa o conto enquanto narrativa, discutindo-o enquanto um
...
JOLLES, André. \emph{Formas simples}. Trad. de Álvaro Cabral. São Paulo,
Cultrix, 1976. --- Este livro examina o conto como forma simples, ao
lado de outras (como legenda, saga, mito, adivinha, ditado, caso,
memorável, chiste), traçando diferenças quanto à forma artística.

POE, Edgar Allan. ``Filosofia da composição''. In: \emph{Ficção
...
TCHÉKHOV, Anton. \emph{Sem trama e sem final: 99 conselhos de escrita}.
