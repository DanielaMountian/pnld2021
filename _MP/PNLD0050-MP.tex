...
% CARICATURA de Lear (pág. 9, PNLD0050-15.png): diminuir e inserir depois do poema da pág. 8 ("...Já está em Belo Horizonte"). 
% RETRATO de Leskóv da pág. 11 (PNLD0050-06.png): inserir depois da frase: "No texto de Leskóv, diferentemente de um texto informativo de jornal, os leitores se tornam quase ouvintes. Enfim, depois de feita uma galeria de personagens, o educando poderia apontar com qual ele mais se identifica e por quê". 
...
% FOTO DE TOLSTÓI COM CRIANÇAS na pág. 14 (PNLD0050-07.png): inserir depois da frase "de uma linguagem saborosa e ao mesmo tempo simples, sem excessos”. 
% ILUSTRAÇÃO de "Mumu" (pág. 15, PNLD0050-08.png): inserir depois de "Guerássim, um brutamontes surdomudo, de caráter duro, mas inocente, que todos temiam e de algum modo respeitavam”. 
% RETRATO de Tchékhov (pág. 16, PNLD0050-03.png): inserir depois da frase "liberdade da opressão, dos preconceitos, ignorância, paixões, etc.’ E denunciar uma situação condenável”. 
% RETRATO de Lídia Avílova (pág. 16, PNLD0050-09.png): colocar ao lado de "Avílova tem o nome geralmente ligado ao de Anton Tchékhov". 
% PARA VER “Prisioneiro das montanhas” (pág. 18): inserir ao lado de "...О prisioneiro do Cáucaso”, incluído na coletânea...". 
% ILUSTRAÇÃO de Fido Nesti para "O prisioneiro do Cáucaso" (pág. 31, PNLD0050-14.png): inserir embaixo de "A apresentação teórica irá surpreender os alunos pela profundidade e pelo trajeto necessário para se desenvolver a narrativa visual dos livros infantojuvenis".
