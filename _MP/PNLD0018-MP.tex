...
\newcommand{\issnppub}{978-65-551908-4-7}
\newcommand{\issnepub}{978-65-551908-5-4}
...
\SideImage{Monumento em homenagem ao autor, localizado em Brocken, na Alemanha (Stefan Schäfer, Lich; \textsc{cc}-\textsc{by}-\textsc{sa}-4.0)}{PNLD0018-04.png}
...
\Image{Aumento do número de refugiados por ano. (Fonte: \textsc{unhcr}; Divulgação)}{PNLD0018-20}
...
\Image{Captura de tela do site liveuamap.com}{PNLD0018-21.png}
...
\SideImage{Cidade de Guernica destruída após bombardeio, 1937. Fonte: Wikipedia. \textsc{cc}-\textsc{by}-\textsc{sa} 3.0}{PNLD0018-22.jpg}
...
sirvam como meio de pesquisa para a atividade \textsc{ii} de pré"-leitura.
...
atividade \textsc{ii} de pré"-leitura.
