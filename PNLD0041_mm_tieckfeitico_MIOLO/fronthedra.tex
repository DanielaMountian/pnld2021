...
\hspace{5pt}Tieck, Ludwig, 1773--1853\\
\hspace{20pt}\parbox{190pt}{Feitiço de amor e outros contos / Ludwig Tieck ;
organização e tradução Karin Volobuef , Maria Aparecida Barbosa. --
1. ed. -- Rio de Janeiro : Mais e Melhores, 2021.}\\[6pt]

\hspace{20pt}ISBN 978-65-994422-0-9  (Livro do Estudante)\\
\hspace{20pt}ISBN 978-65-994422-3-0  (Manual do Professor)\\[6pt]

\hspace{20pt}\parbox{190pt}{1. Ficção alemã I. Título.}\\[6pt]

\hspace{20pt}21-61211 \hspace{138pt}\versal{CDD}-833\\

\hrulefill\\

\noindent{}Índices para catálogo sistemático:\\
\noindent{}1. Ficção : Literatura alemã 833\\[6pt]
\noindent{}Elaborado por Aline Graziele Benitez -- Bibliotecária -- CRB-1/3129
...
\ifdef{\tradutor}{{\small {\tradutor}\\ (\textit{organização e tradução})}\par}{}\vspace{8.5mm}
