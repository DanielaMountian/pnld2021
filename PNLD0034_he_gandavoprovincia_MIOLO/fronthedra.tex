...
G195 \hspace{5pt}Gandavo \\
\hspace{20pt}\parbox{190pt}{História da província de Santa Cruz / Gandavo; Ricardo Martins Valle (Organizador) – Brasília-DF: Trilha do Saber, 2021.}\\[6pt]

\hspace{20pt}ISBN 978-65-994235-0-5 (Livro do Estudante)\\
\hspace{20pt}ISBN 978-65-994235-2-9  (Manual do Professor)\\[6pt]

\hspace{20pt}\parbox{190pt}{1. História do Brasil. 2. Clássico da literatura brasileira. I. Gandavo. II. Valle, Ricardo Martins (Organizador). III. Título.}\\[6pt]

\hspace{188pt}\versal{CDD} 981\\

\hrulefill\\
\noindent{}Índice para catálogo sistemático\\
\noindent{}I. História do Brasil\\[6pt]
...
\vfill
\normalsize
\ifdef{\hfill\includegraphics[width=3cm]{\logoeditora}\\ Brasília\quad\the\year}
