...
\hspace{5pt}Assis, Machado de, 1839--1908\\
\hspace{20pt}\parbox{190pt}{O alienista ; O imortal ; A cartomante / Machado
de Assis ; Alcides Villaça, João Adolfo Hansen,
Jean Pierre Chauvin (organização). -- 1. ed. --
Belo Horizonte : Piseagrama, 2021.}\\[6pt]

\hspace{20pt}ISBN 978-65-89833-02-4  (Livro do Estudante)\\
\hspace{20pt}ISBN 978-65-89833-03-1  (Manual do Professor)\\[6pt]

\hspace{20pt}\parbox{190pt}{1. Contos brasileiros I. Villaça, Alcides.
II. Hansen, João Adolfo. III. Chauvin, Jean Pierre.
IV. Título. V. Título: O imortal. VI. Título: A
cartomante.}\\[6pt]

\hspace{20pt}21-60904 \hspace{138pt}\versal{CDD}-B869.3\\

\hrulefill\\

\noindent{}Índices para catálogo sistemático:\\
\noindent{}1. Contos : Literatura brasileira B869.3\\[6pt]
...
\vfill
\normalsize
\ifdef{\hfill\includegraphics[width=3cm]{\logoeditora}\\ Belo Horizonte\quad\the\year}
