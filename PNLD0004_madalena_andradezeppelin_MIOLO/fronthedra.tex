...
\hspace{5pt}Andrade, Mário de, 1893--1945\\
\hspace{20pt}\parbox{190pt}{Zeppelin : algumas crônicas de Mário de Andrade /
Rodrigo Jorge Ribeiro Neves (organização). --
1. ed. -- São Paulo : Editora Madalena : 2021.}\\[6pt]

\hspace{20pt}ISBN 978-65-88934-01-2 (Livro do Estudante)\\
\hspace{20pt}ISBN 978-65-88934-04-3 (Manual do Professor)\\[6pt]

\hspace{20pt}\parbox{190pt}{1. Crônicas brasileiras I. Neves, Rodrigo Jorge
Ribeiro. II. Título.}\\[6pt]

\hspace{20pt}21-60034 \hspace{138pt}\versal{CDD}-B869.8

\hrulefill

\noindent\textbf{Índice para catálogo sistemático}

\noindent{}1. Crônicas : Literatura brasileira B869.8\smallskip
