\chapter[Apresentação \bigskip]{Apresentação}
...
\textls[-10]{Tudo isso são coisas que se provam por si pra que eu insista sobre. Em
...
\textls[-20]{E de"-fato será sempre ``feia'' porque apenas estátua. Um bronzinho magro,
...
um bibelô.} \enlargethispage{\baselineskip}
...
\textls[-10]{O contato com os livros e manuscritos dessas idades que irreverentemente
...
\textls[-5]{E cheguei com certo esforço adonde pressentia que desejava chegar: o
...
\textls[-10]{Isso nem o ótimo livro moderno conseguirá nos fornecer. O livro antigo é
...
\textls[-20]{Porque esta é a realidade mais inesperada e fecunda: a fotomontagem é um
...
\textls[-10]{As composições fotográficas que apresento nesta página me parecem
...
\textls[-10]{A fotomontagem é uma espécie de introdução à arte moderna. Ainda há
...
\textls[-5]{Sou brasileiro, nasci em Mato Grosso, nos limites do Paraguai e por
...
\textls[-5]{Até aqui vai o que meu tio conta e que na sua tristíssima obsessão da
...
\textls[-15]{Assim os três relógios do \emph{hall}, um possuía corda para 15 dias, outro
...
\textls[-25]{A velha bruxa resultou louca também e vive rindo pacífica, dizendo
