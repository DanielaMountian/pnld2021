...
\hspace{5pt}Maistre, Xavier de, 1763--1852\\
\hspace{20pt}\parbox{190pt}{Viagem em volta do meu quarto / Xavier de
Maistre ; Sandra M. Stroparo (organização e
tradução). -- 1. ed. -- São Francisco de Paula, RS :
Araucária Edições, 2021.}\\[6pt]

\hspace{20pt}ISBN 978-65-994481-1-9 (Livro do Estudante)\\
\hspace{20pt}ISBN 978-65-994481-2-6  (Manual do Professor)\\[6pt]

\hspace{20pt}\parbox{190pt}{1. Ficção francesa I. Stroparo, Sandra M. II. Título.}\\[6pt]

\hspace{20pt}21-61632 \hspace{138pt}\versal{CDD}-843\\

\hrulefill

\noindent{}\textbf{Índices para catálogo sistemático:}\\
\noindent{}1. 1. Ficção : Literatura francesa 843\\[6pt]
\noindent{}Elaborado por Cibele Maria Dias -- Bibliotecária -- CRB-8/9427
...
\vfill
\normalsize
\ifdef{\hfill\includegraphics[width=3cm]{\logoeditora}\\ São Francisco de Paula\quad\the\year}
