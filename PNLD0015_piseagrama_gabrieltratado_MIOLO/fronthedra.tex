...
\hspace{5pt}Sousa, Gabriel Soares de\\
\hspace{20pt}\parbox{190pt}{Tratado descritivo do Brasil / Gabriel Soares de
Sousa ; Fernanda Trindade Luciani (organização). --
1. ed. -- Belo Horizonte : \mbox{Piseagrama}, 2021.}\\[6pt]

\hspace{20pt}ISBN 978-65-89833-00-0  (Livro do Estudante)\\
\hspace{20pt}ISBN 978-65-89833-01-7  (Manual do Professor)\\[6pt]

\hspace{20pt}\parbox{190pt}{1. Brasil - Descrições e viagens - Obras
anteriores a 1800 I. Luciani, Fernanda Trindade. II. Título.}\\[6pt]

\hspace{20pt}21-60902 \hspace{138pt}\versal{CDD}-918.1\\

\hrulefill\\
\noindent{}Índices para catálogo sistemático:\\
\noindent{}1. Brasil : Descrição e viagens 918.1\\[6pt]
\noindent{}Elaborada por Cibele Maria Dias -- Bibliotecária -- CRB-8/9427
