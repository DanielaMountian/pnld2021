...
\hspace{38pt}\tiny\textit{Direitos cedidos à Editora Piseagrama}\medskip

%\linhalayout{edição brasileira©}{Hedra \ifdef{\ano}{\ano}{\the\year}}
\linha{estabelecimento de texto©}{\copyrightorganizacao}
\linha{notas©}{\copyrightorganizacao}
\linha{tradução©}{\copyrighttraducao}
\linha{prefácio©}{\copyrightorganizacao}
