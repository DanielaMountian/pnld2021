...
J89 \hspace{5pt}Joyce, James \\
\hspace{20pt}\parbox{190pt}{Retrato do artista quando jovem / James Joyce; Elton Mesquita (Tradutor) – Rio de Janeiro: Prosper, 2021.}\\[6pt]

\hspace{20pt}ISBN 978-65-994233-2-1 (Livro do Estudante)\\
\hspace{20pt}ISBN 978-65-994233-0-7  (Livro do Professor)\\[6pt]

\hspace{20pt}\parbox{190pt}{1. Ficção. 2. Literatura Irlandesa. 3. Clássico da literatura. I. Joyce, James. II. Mesquita, Elton (Tradutor). III. Título.}\\[6pt]

\hspace{188pt}\versal{CDD} 981\\

\hrulefill\\
\noindent{}Índice para catálogo sistemático\\
\noindent{}I. Ficção : Literatura Irlandesa\\[6pt]
