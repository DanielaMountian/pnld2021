...
\part*{\textsc{incidentes da vida de uma escrava, escritos por ela mesma}}
...
\textls[-5]{Eles parecem satisfazer suas
...
\textls[-20]{Aquela pobre ignorante achava que a
...
\textls[-25]{Esses momentos são preciosos para os
...
\textls[-15]{Há homens que ficariam felizes em
...
\textls[-10]{Quando volta para casa, ele publica uma ``Visão Sulista sobre a
...
\textls[-10]{O que é que \emph{ele} sabe dos
...
\textls[-10]{--- Muito bem. Vá para a fazenda,
...
\textls[-10]{Respondi que seria inútil tentar, mas
...
\textls[-15]{Eu não ignorava. Minha presença oculta era uma fonte constante de
...
\textls[-10]{Na manhã seguinte eu espiei pela minha
...
\textls[-35]{--- Mas eu quero trazer mais uma mulher
...
\textls[-30]{O capitão concordou em aguardar em um
...
\textls[-15]{Fiz todos os preparativos para embarcar
...
\textls[-10]{--- Mãe, eu acho bom que você esteja indo embora. Eu queria poder ir
...
\textls[-10]{Perguntei se ele alguma vez mencionara
...
\textls[-10]{Nós três nos ajoelhamos juntos, com meu filho agarrado contra o meu
...
\textls[-20]{Eu ouvira falar que o pobre escravo tem
...
\textls[-5]{Agradeci e pedi que me indicasse algumas lojas onde poderia comprar
...
\textls[-40]{A palavra \emph{desprezo} ardia em mim como um carvão em brasa.}
...
\textls[-20]{Ao raiar do dia, ouvi mulheres
...
\textls[-30]{Quando nos entregou nossos bilhetes, o Sr.\,Durham disse:}

\textls[-28]{--- Infelizmente, vocês terão uma viagem desagradável, mas foi
