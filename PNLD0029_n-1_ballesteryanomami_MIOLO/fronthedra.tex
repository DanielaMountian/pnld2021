...
S676s\hspace{5pt}Soares, Anne Ballester\\
\hspace{20pt}\parbox{190pt}{O surgimento da noite: Mitologias yanomami / Anne Ballester
Soares (organização e tradução). -- São Paulo : N-1 edições, 2021.}\\[6pt]

\hspace{20pt}ISBN 978-65-86941-35-7 (Livro do Estudante)\\
\hspace{20pt}ISBN 978-65-86941-36-4  (Manual do Professor)\\[6pt]

\hspace{20pt}\parbox{190pt}{1. Mitologia indígena. 2. Mitologias yanomami. 3. Histórias. 4.
Culturao. I. Título.}\\[6pt]

\hspace{20pt}2021-1380 \hspace{138pt}\versal{CDD} 398.2\\
\hspace{188pt}\versal{CDU} 397
