...
\linha{organização©}{Giuliana Ragusa}
...
\hspace{5pt}Safo\\
\hspace{20pt}\parbox{190pt}{Hino a Afrodite e outros poemas / Safo de Lesbos ;
Giuliana Ragusa (organização) ; Giuliana Ragusa (tradução). -- 1. ed. -- São Paulo : Escola de Pais, 2021.}\\[6pt]

\hspace{20pt}ISBN 978-65-994439-2-3  (Livro do Estudante)\\
\hspace{20pt}ISBN 978-65-994439-1-6  (Manual do Professor)\\[6pt]

\hspace{20pt}\parbox{190pt}{1. Poesia grega I. Ragusa, Giuliana. II. Título.}\\[6pt]

\hspace{20pt}21-61453 \hspace{138pt}\versal{CDD}-881\\

\hrulefill\\

\noindent{}Índices para catálogo sistemático:\\
\noindent{}1. Poesia : Literatura grega clássica 881\\[6pt]
