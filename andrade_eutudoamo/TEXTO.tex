...
%\settowidth{\versewidth}{xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx}
...
\emph{\textsc{Casados e Solteiros}} (coral misto a quatro vozes):
...
Sorri. sorri. E, à o oprime,

Sai-lhe a , , e convulsa.
...
Abandonando as vadias,

de e de invernias,

desconfianças, afrontando a ,
...
Viajei a , o desengana

E de enrista

os da .

Voltei, das juvenis ao ,
...
Voltei, Jasão voltando de Argos,
...
\footnote{Nota de Mário de Andrade: ``O soneto XXVIII de Cláudio Manuel
  da Costa (ed. Garnier) repete quase a mesma ideia, terminando `Tão
  longe dela estou e estou tão perto'. Gosto muito de Cláudio Manuel,
  talvez seja isso'' (ANDRADE, Mário de, op. cit., p. ).}
...
E foi. Bianco avançou ; ... ; Netinho centrou Mário
...
\textsc{Losangos arlequinais}\footnote{Publicado , em 2 de janeiro de
  1926, seção do jornal carioca \emph{A Noite}, como lembram Telê Ancona
  Lopez e Tatiana Longo Figueiredo (ANDRADE, Mário de, op. cit., p. ).}

\textsc{(Sonetos condensados)}
